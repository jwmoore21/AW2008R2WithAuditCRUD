/*
IF EXISTS (SELECT 1 FROM [sys].[objects] WHERE object_id = OBJECT_ID(N'[Person].[uspDel_Person]') AND type in (N'P', N'PC'))
DROP PROCEDURE [Person].[uspDel_Person]
GO
*/

CREATE PROCEDURE [Person].[uspDel_Person]
    ...
    BEGIN
      ...
      BEGIN
        ...
        SELECT
          ...
          ,[OutputTableVar].[PersonType]
          ,[OutputTableVar].[NameStyle]
          ,[OutputTableVar].[Title]
          ,[OutputTableVar].[FirstName]
          ,[OutputTableVar].[MiddleName]
          ,[OutputTableVar].[LastName]
          ,[OutputTableVar].[Suffix]
          ,[OutputTableVar].[EmailPromotion]
          ,[OutputTableVar].[AdditionalContactInfo]
          ,[OutputTableVar].[Demographics]
