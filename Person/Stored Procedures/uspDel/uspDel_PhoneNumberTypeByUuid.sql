/*
IF EXISTS (SELECT 1 FROM [sys].[objects] WHERE object_id = OBJECT_ID(N'[Person].[uspDel_PhoneNumberTypeByUuid]') AND type in (N'P', N'PC'))
DROP PROCEDURE [Person].[uspDel_PhoneNumberTypeByUuid]
GO
*/

CREATE PROCEDURE [Person].[uspDel_PhoneNumberTypeByUuid]
...
================================================================================
Schema:      Person
Object:      uspDel_PhoneNumberTypeByUuid
...
BEGIN
  ...
  BEGIN TRY
    ...
    SET @_AuditOperation = COALESCE( @AuditOperation, 'Delete proc ran: uspDel_PhoneNumberTypeByUuid' );
...
EXEC Person.uspDel_PhoneNumberTypeByUuid
  @Uuid = @Uuid,
...
EXECUTE sp_addextendedproperty
  ...
  @level1name = N'uspDel_PhoneNumberTypeByUuid';
GO