/*
IF EXISTS (SELECT 1 FROM [sys].[objects] WHERE object_id = OBJECT_ID(N'[Person].[uspDel_PhoneNumberType]') AND type in (N'P', N'PC'))
DROP PROCEDURE [Person].[uspDel_PhoneNumberType]
GO
*/

CREATE PROCEDURE [Person].[uspDel_PhoneNumberType]
  ...
  BEGIN TRY
    ...
    BEGIN
      ...
      BEGIN
        ...
        SELECT
           [OutputTableVar].[PhoneNumberTypeID]
          ,[OutputTableVar].[Name]
...
EXEC Person.uspDel_PhoneNumberType
...
EXECUTE sp_addextendedproperty
  ...
  @level1name = N'uspDel_PhoneNumberType';
GO