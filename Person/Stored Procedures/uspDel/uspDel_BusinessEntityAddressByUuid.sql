/*
IF EXISTS (SELECT 1 FROM [sys].[objects] WHERE object_id = OBJECT_ID(N'[Person].[uspDel_BusinessEntityAddressByUuid]') AND type in (N'P', N'PC'))
DROP PROCEDURE [Person].[uspDel_BusinessEntityAddressByUuid]
GO
*/

CREATE PROCEDURE [Person].[uspDel_BusinessEntityAddressByUuid]
...
================================================================================
Schema:      Person
Object:      uspDel_BusinessEntityAddressByUuid
...
BEGIN
  ...
  BEGIN TRY
    ...
    SET @_AuditOperation = COALESCE( @AuditOperation, 'Delete proc ran: uspDel_BusinessEntityAddressByUuid' );
    ...
    BEGIN
      ...
      WHERE
        [BusinessEntityAddress].[Uuid] = @_Uuid
      ;
...
EXEC Person.uspDel_BusinessEntityAddressByUuid
  @Uuid = @Uuid,
...
EXECUTE sp_addextendedproperty
  ...
  @level1name = N'uspDel_BusinessEntityAddressByUuid';
GO