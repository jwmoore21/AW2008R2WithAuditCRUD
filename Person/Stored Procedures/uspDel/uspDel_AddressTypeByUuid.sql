/*
IF EXISTS (SELECT 1 FROM [sys].[objects] WHERE object_id = OBJECT_ID(N'[Person].[uspDel_AddressTypeByUuid]') AND type in (N'P', N'PC'))
DROP PROCEDURE [Person].[uspDel_AddressTypeByUuid]
GO
*/

CREATE PROCEDURE [Person].[uspDel_AddressTypeByUuid]
...
================================================================================
Schema:      Person
Object:      uspDel_AddressTypeByUuid
...
BEGIN
  ...
  BEGIN TRY
    ...
    SET @_AuditOperation = COALESCE( @AuditOperation, 'Delete proc ran: uspDel_AddressTypeByUuid' );
...
EXEC Person.uspDel_AddressTypeByUuid
  @Uuid = @Uuid,
...
EXECUTE sp_addextendedproperty
  ...
  @level1name = N'uspDel_AddressTypeByUuid';
GO