/*
IF EXISTS (SELECT 1 FROM [sys].[objects] WHERE object_id = OBJECT_ID(N'[Person].[uspDel_StateProvinceByUuid]') AND type in (N'P', N'PC'))
DROP PROCEDURE [Person].[uspDel_StateProvinceByUuid]
GO
*/

CREATE PROCEDURE [Person].[uspDel_StateProvinceByUuid]
...
================================================================================
Schema:      Person
Object:      uspDel_StateProvinceByUuid
...
BEGIN
  ...
  BEGIN TRY
    ...
    SET @_AuditOperation = COALESCE( @AuditOperation, 'Delete proc ran: uspDel_StateProvinceByUuid' );
...
EXEC Person.uspDel_StateProvinceByUuid
  @Uuid = @Uuid,
...
EXECUTE sp_addextendedproperty
  ...
  @level1name = N'uspDel_StateProvinceByUuid';
GO