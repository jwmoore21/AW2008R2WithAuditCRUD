/*
IF EXISTS (SELECT 1 FROM [sys].[objects] WHERE object_id = OBJECT_ID(N'[Person].[uspDel_CountryRegionWithAudit]') AND type in (N'P', N'PC'))
DROP PROCEDURE [Person].[uspDel_CountryRegionWithAudit]
GO
*/

CREATE PROCEDURE [Person].[uspDel_CountryRegionWithAudit]
...
================================================================================
Schema:      Person
Object:      uspDel_CountryRegionWithAudit
...
BEGIN
  ...
  BEGIN TRY
    ...
    SET @_AuditOperation = COALESCE( @AuditOperation, 'Delete proc ran: uspDel_CountryRegionWithAudit' );
...
EXEC Person.uspDel_CountryRegionWithAudit
...
EXECUTE sp_addextendedproperty
  ...
  @level1name = N'uspDel_CountryRegionWithAudit';
GO