/*
IF EXISTS (SELECT 1 FROM [sys].[objects] WHERE object_id = OBJECT_ID(N'[Person].[uspDel_PersonWithAudit]') AND type in (N'P', N'PC'))
DROP PROCEDURE [Person].[uspDel_PersonWithAudit]
GO
*/

CREATE PROCEDURE [Person].[uspDel_PersonWithAudit]
...
BEGIN
  ...
  BEGIN TRY
    ...
    SET @_AuditOperation = COALESCE( @AuditOperation, 'Delete proc ran: uspDel_PersonWithAudit' );
    ...
    (
      ...
      AND OBJECT_NAME([so].[parent_obj]) = 'Person'
    ...
    BEGIN
      ...
      WHERE
        [Person].[BusinessEntityID] = @_BusinessEntityID
      ;
    ...
    FROM
      [Audit].[AuditPerson] AS [AuditPerson] WITH(NOLOCK)
    WHERE
      [AuditPerson].[AuditBatchId] = @_AuditBatchId;
    ...
    BEGIN
      ...
      BEGIN
        ...
        SELECT
           [AuditPerson].[BusinessEntityID]
          ,[AuditPerson].[PersonType]
          ,[AuditPerson].[NameStyle]
          ,[AuditPerson].[Title]
          ,[AuditPerson].[FirstName]
          ,[AuditPerson].[MiddleName]
          ,[AuditPerson].[LastName]
          ,[AuditPerson].[Suffix]
          ,[AuditPerson].[EmailPromotion]
          ,[AuditPerson].[AdditionalContactInfo]
          ,[AuditPerson].[Demographics]
          ,[AuditPerson].[rowguid]
          ,[AuditPerson].[RowStatus]
          ,[AuditPerson].[CreatedBy]
          ,[AuditPerson].[ModifiedBy]
          ,[AuditPerson].[CreatedDate]
          ,[AuditPerson].[ModifiedDate]
          ,[AuditPerson].[Uuid]
        FROM
          [Audit].[AuditPerson] AS [AuditPerson] WITH(NOLOCK)
        WHERE
        ...
        BEGIN TRY
          SELECT
            ...
            (
              ...
              WHERE
                [AuditPerson].[AuditBatchId] = @_AuditBatchId
              FOR XML PATH ('Person'), ROOT ('DeletedRecords'), ELEMENTS XSINIL
            );
...
EXEC Person.uspDel_PersonWithAudit
...
SELECT AuditPerson.*
FROM   Audit.AuditPerson AS AuditPerson WITH(NOLOCK)
WHERE
  AuditPerson.AuditBatchId = @AuditBatchId
;
...
EXECUTE sp_addextendedproperty
  ...
  @level1name = N'uspDel_PersonWithAudit';
GO