/*
IF EXISTS (SELECT 1 FROM [sys].[objects] WHERE object_id = OBJECT_ID(N'[Person].[uspDel_address]') AND type in (N'P', N'PC'))
DROP PROCEDURE [Person].[uspDel_address]
GO
*/

CREATE PROCEDURE [Person].[uspDel_address]
  @AddressID INT,
  ...
  BEGIN TRY
    ...
    BEGIN
      ...
      BEGIN
        ...
        SELECT
           [OutputTableVar].[AddressID]
          ,[OutputTableVar].[AddressLine1]
          ,[OutputTableVar].[AddressLine2]
          ,[OutputTableVar].[City]
          ,[OutputTableVar].[StateProvinceID]
          ,[OutputTableVar].[PostalCode]
          ,[OutputTableVar].[SpatialLocation]
