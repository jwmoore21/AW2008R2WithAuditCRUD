/*
IF EXISTS (SELECT 1 FROM [sys].[objects] WHERE object_id = OBJECT_ID(N'[Person].[uspDel_EmailAddressByUuid]') AND type in (N'P', N'PC'))
DROP PROCEDURE [Person].[uspDel_EmailAddressByUuid]
GO
*/

CREATE PROCEDURE [Person].[uspDel_EmailAddressByUuid]
...
================================================================================
Schema:      Person
Object:      uspDel_EmailAddressByUuid
...
BEGIN
  ...
  BEGIN TRY
    ...
    SET @_AuditOperation = COALESCE( @AuditOperation, 'Delete proc ran: uspDel_EmailAddressByUuid' );
...
EXEC Person.uspDel_EmailAddressByUuid
  @Uuid = @Uuid,
...
EXECUTE sp_addextendedproperty
  ...
  @level1name = N'uspDel_EmailAddressByUuid';
GO