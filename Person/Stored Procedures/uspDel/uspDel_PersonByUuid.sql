/*
IF EXISTS (SELECT 1 FROM [sys].[objects] WHERE object_id = OBJECT_ID(N'[Person].[uspDel_PersonByUuid]') AND type in (N'P', N'PC'))
DROP PROCEDURE [Person].[uspDel_PersonByUuid]
GO
*/

CREATE PROCEDURE [Person].[uspDel_PersonByUuid]
...
BEGIN
  ...
  BEGIN TRY
    ...
    SET @_AuditOperation = COALESCE( @AuditOperation, 'Delete proc ran: uspDel_PersonByUuid' );
...
EXEC Person.uspDel_PersonByUuid
  @Uuid = @Uuid,
...
EXECUTE sp_addextendedproperty
  ...
  @level1name = N'uspDel_PersonByUuid';
GO