/*
IF EXISTS (SELECT 1 FROM [sys].[objects] WHERE object_id = OBJECT_ID(N'[Person].[uspDel_BusinessEntityContactByUuid]') AND type in (N'P', N'PC'))
DROP PROCEDURE [Person].[uspDel_BusinessEntityContactByUuid]
GO
*/

CREATE PROCEDURE [Person].[uspDel_BusinessEntityContactByUuid]
...
================================================================================
Schema:      Person
Object:      uspDel_BusinessEntityContactByUuid
...
BEGIN
  ...
  BEGIN TRY
    ...
    SET @_AuditOperation = COALESCE( @AuditOperation, 'Delete proc ran: uspDel_BusinessEntityContactByUuid' );
    ...
    BEGIN
      ...
      WHERE
        [BusinessEntityContact].[Uuid] = @_Uuid
      ;
...
EXEC Person.uspDel_BusinessEntityContactByUuid
  @Uuid = @Uuid,
...
EXECUTE sp_addextendedproperty
  ...
  @level1name = N'uspDel_BusinessEntityContactByUuid';
GO