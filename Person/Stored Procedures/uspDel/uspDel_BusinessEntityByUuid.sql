/*
IF EXISTS (SELECT 1 FROM [sys].[objects] WHERE object_id = OBJECT_ID(N'[Person].[uspDel_BusinessEntityByUuid]') AND type in (N'P', N'PC'))
DROP PROCEDURE [Person].[uspDel_BusinessEntityByUuid]
GO
*/

CREATE PROCEDURE [Person].[uspDel_BusinessEntityByUuid]
...
================================================================================
Schema:      Person
Object:      uspDel_BusinessEntityByUuid
...
BEGIN
  ...
  BEGIN TRY
    ...
    SET @_AuditOperation = COALESCE( @AuditOperation, 'Delete proc ran: uspDel_BusinessEntityByUuid' );
...
EXEC Person.uspDel_BusinessEntityByUuid
  @Uuid = @Uuid,
...
EXECUTE sp_addextendedproperty
  ...
  @level1name = N'uspDel_BusinessEntityByUuid';
GO