/*
IF EXISTS (SELECT 1 FROM [sys].[objects] WHERE object_id = OBJECT_ID(N'[Person].[uspDel_password]') AND type in (N'P', N'PC'))
DROP PROCEDURE [Person].[uspDel_password]
GO
*/

CREATE PROCEDURE [Person].[uspDel_password]
    ...
    BEGIN
      ...
      BEGIN
        ...
        SELECT
          ...
          ,[OutputTableVar].[PasswordHash]
          ,[OutputTableVar].[PasswordSalt]
