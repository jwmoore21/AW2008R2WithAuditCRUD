/*
IF EXISTS (SELECT 1 FROM [sys].[objects] WHERE object_id = OBJECT_ID(N'[Person].[uspDel_AddressByUuid]') AND type in (N'P', N'PC'))
DROP PROCEDURE [Person].[uspDel_AddressByUuid]
GO
*/

CREATE PROCEDURE [Person].[uspDel_AddressByUuid]
...
BEGIN
  ...
  BEGIN TRY
    ...
    SET @_AuditOperation = COALESCE( @AuditOperation, 'Delete proc ran: uspDel_AddressByUuid' );
...
EXEC Person.uspDel_AddressByUuid
  @Uuid = @Uuid,
...
EXECUTE sp_addextendedproperty
  ...
  @level1name = N'uspDel_AddressByUuid';
GO