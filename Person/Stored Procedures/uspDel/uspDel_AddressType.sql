/*
IF EXISTS (SELECT 1 FROM [sys].[objects] WHERE object_id = OBJECT_ID(N'[Person].[uspDel_addresstype]') AND type in (N'P', N'PC'))
DROP PROCEDURE [Person].[uspDel_addresstype]
GO
*/

CREATE PROCEDURE [Person].[uspDel_addresstype]
  @AddressTypeID INT,
...
EXEC Person.uspDel_addresstype
...
EXECUTE sp_addextendedproperty
  ...
  @level1name = N'uspDel_addresstype';
GO