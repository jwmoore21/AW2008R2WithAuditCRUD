/*
IF EXISTS (SELECT 1 FROM [sys].[objects] WHERE object_id = OBJECT_ID(N'[Person].[uspDel_ContactTypeByUuid]') AND type in (N'P', N'PC'))
DROP PROCEDURE [Person].[uspDel_ContactTypeByUuid]
GO
*/

CREATE PROCEDURE [Person].[uspDel_ContactTypeByUuid]
...
================================================================================
Schema:      Person
Object:      uspDel_ContactTypeByUuid
...
BEGIN
  ...
  BEGIN TRY
    ...
    SET @_AuditOperation = COALESCE( @AuditOperation, 'Delete proc ran: uspDel_ContactTypeByUuid' );
...
EXEC Person.uspDel_ContactTypeByUuid
  @Uuid = @Uuid,
...
EXECUTE sp_addextendedproperty
  ...
  @level1name = N'uspDel_ContactTypeByUuid';
GO