/*
IF EXISTS ( SELECT 1 FROM sys.triggers WHERE object_id = object_id(N'[Person].[TRG__EmailAddress__instead_of_del]'))
DROP TRIGGER [Person].[TRG__EmailAddress__instead_of_del]
GO
*/
CREATE TRIGGER [Person].[TRG__EmailAddress__instead_of_del] ON [Person].[EmailAddress]
  INSTEAD OF DELETE
AS

/*******************************************************************************
Schema:      Person
Object:      TRG__EmailAddress__instead_of_del
...
BEGIN
  ...
  BEGIN TRY
    ...
    SET @_AuditOperation = 'Autosave by: INSTEAD OF DELETE Trigger : TRG__EmailAddress__instead_of_del';
    ...
    FROM [Person].[EmailAddress] AS recordsToErase
