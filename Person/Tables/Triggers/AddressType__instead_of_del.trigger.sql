/*
IF EXISTS ( SELECT 1 FROM sys.triggers WHERE object_id = object_id(N'[Person].[TRG__AddressType__instead_of_del]'))
DROP TRIGGER [Person].[TRG__AddressType__instead_of_del]
GO
*/
CREATE TRIGGER [Person].[TRG__AddressType__instead_of_del] ON [Person].[AddressType]
  INSTEAD OF DELETE
AS

/*******************************************************************************
Schema:      Person
Object:      TRG__AddressType__instead_of_del
...
BEGIN
  ...
  BEGIN TRY
    ...
    SET @_AuditOperation = 'Autosave by: INSTEAD OF DELETE Trigger : TRG__AddressType__instead_of_del';
    ...
    FROM [Person].[AddressType] AS recordsToErase
