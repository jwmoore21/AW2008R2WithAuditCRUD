...
/* Defaults */
ALTER TABLE [Person].[EmailAddress] ADD CONSTRAINT [DF__EmailAddress__RowStatus] DEFAULT ((1)) FOR [RowStatus]
GO

ALTER TABLE [Person].[EmailAddress] ADD CONSTRAINT [DF__EmailAddress__CreatedBy] DEFAULT ('4E3A7D6D-8351-8494-FDB7-39E2A3A2E972') FOR [CreatedBy]
GO

ALTER TABLE [Person].[EmailAddress] ADD CONSTRAINT [DF__EmailAddress__ModifiedBy] DEFAULT ('4E3A7D6D-8351-8494-FDB7-39E2A3A2E972') FOR [ModifiedBy]
GO

ALTER TABLE [Person].[EmailAddress] ADD CONSTRAINT [DF__EmailAddress__CreatedDate] DEFAULT (GETUTCDATE()) FOR [CreatedDate]
GO

ALTER TABLE [Person].[EmailAddress] ADD CONSTRAINT [DF__EmailAddress__ModifiedDate] DEFAULT (GETUTCDATE()) FOR [ModifiedDate]
GO

ALTER TABLE [Person].[EmailAddress] ADD CONSTRAINT [DF__EmailAddress__Uuid] DEFAULT (NEWID()) FOR [Uuid]
GO
...
EXECUTE sp_addextendedproperty @name = N'MS_Description', @value = N'Default constraint value of GETDATE()', @level0type = N'SCHEMA', @level0name = N'Person', @level1type = N'TABLE', @level1name = N'EmailAddress', @level2type = N'CONSTRAINT', @level2name = N'DF__EmailAddress__ModifiedDate';
GO
