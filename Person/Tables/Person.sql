...
/* Defaults */
ALTER TABLE [Person].[Person] ADD CONSTRAINT [DF__Person__RowStatus] DEFAULT ((1)) FOR [RowStatus]
GO

ALTER TABLE [Person].[Person] ADD CONSTRAINT [DF__Person__CreatedBy] DEFAULT ('4E3A7D6D-8351-8494-FDB7-39E2A3A2E972') FOR [CreatedBy]
GO

ALTER TABLE [Person].[Person] ADD CONSTRAINT [DF__Person__ModifiedBy] DEFAULT ('4E3A7D6D-8351-8494-FDB7-39E2A3A2E972') FOR [ModifiedBy]
GO

ALTER TABLE [Person].[Person] ADD CONSTRAINT [DF__Person__CreatedDate] DEFAULT (GETUTCDATE()) FOR [CreatedDate]
GO

ALTER TABLE [Person].[Person] ADD CONSTRAINT [DF__Person__ModifiedDate] DEFAULT (GETUTCDATE()) FOR [ModifiedDate]
GO

ALTER TABLE [Person].[Person] ADD CONSTRAINT [DF__Person__Uuid] DEFAULT (NEWID()) FOR [Uuid]
GO
...
EXECUTE sp_addextendedproperty @name = N'MS_Description', @value = N'Default constraint value of GETDATE()', @level0type = N'SCHEMA', @level0name = N'Person', @level1type = N'TABLE', @level1name = N'Person', @level2type = N'CONSTRAINT', @level2name = N'DF__Person__ModifiedDate';
GO
