/*
IF EXISTS (SELECT 1 FROM [sys].[objects] WHERE object_id = OBJECT_ID(N'[dbo].[uspDel_ErrorLogByUuid]') AND type in (N'P', N'PC'))
DROP PROCEDURE [dbo].[uspDel_ErrorLogByUuid]
GO
*/

CREATE PROCEDURE [dbo].[uspDel_ErrorLogByUuid]
...
BEGIN
  ...
  BEGIN TRY
    ...
    SET @_AuditOperation = COALESCE( @AuditOperation, 'Delete proc ran: uspDel_ErrorLogByUuid' );
...
EXEC dbo.uspDel_ErrorLogByUuid
  @Uuid = @Uuid,
...
EXECUTE sp_addextendedproperty
  ...
  @level1name = N'uspDel_ErrorLogByUuid';
GO