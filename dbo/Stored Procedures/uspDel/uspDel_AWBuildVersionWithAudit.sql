/*
IF EXISTS (SELECT 1 FROM [sys].[objects] WHERE object_id = OBJECT_ID(N'[dbo].[uspDel_AWBuildVersionWithAudit]') AND type in (N'P', N'PC'))
DROP PROCEDURE [dbo].[uspDel_AWBuildVersionWithAudit]
GO
*/

CREATE PROCEDURE [dbo].[uspDel_AWBuildVersionWithAudit]
...
================================================================================
Schema:      dbo
Object:      uspDel_AWBuildVersionWithAudit
...
BEGIN
  ...
  BEGIN TRY
    ...
    SET @_AuditOperation = COALESCE( @AuditOperation, 'Delete proc ran: uspDel_AWBuildVersionWithAudit' );
...
EXEC dbo.uspDel_AWBuildVersionWithAudit
...
EXECUTE sp_addextendedproperty
  ...
  @level1name = N'uspDel_AWBuildVersionWithAudit';
GO