/*
IF EXISTS (SELECT 1 FROM [sys].[objects] WHERE object_id = OBJECT_ID(N'[dbo].[uspDel_AWBuildVersionByUuid]') AND type in (N'P', N'PC'))
DROP PROCEDURE [dbo].[uspDel_AWBuildVersionByUuid]
GO
*/

CREATE PROCEDURE [dbo].[uspDel_AWBuildVersionByUuid]
...
================================================================================
Schema:      dbo
Object:      uspDel_AWBuildVersionByUuid
...
BEGIN
  ...
  BEGIN TRY
    ...
    SET @_AuditOperation = COALESCE( @AuditOperation, 'Delete proc ran: uspDel_AWBuildVersionByUuid' );
    ...
    (
      ...
      AND [tables].[name] = 'AuditAWBuildVersion'
    );
    ...
    (
      ...
      AND OBJECT_NAME([so].[parent_obj]) = 'AWBuildVersion'
    ...
    FROM
      [Audit].[AuditAWBuildVersion] AS [AuditAWBuildVersion] WITH(NOLOCK)
    WHERE
      [AuditAWBuildVersion].[AuditBatchId] = @_AuditBatchId;
    ...
    BEGIN
      ...
      BEGIN
        ...
        SELECT
           [AuditAWBuildVersion].[SystemInformationID]
          ,[AuditAWBuildVersion].[Database Version]
          ,[AuditAWBuildVersion].[VersionDate]
          ,[AuditAWBuildVersion].[ModifiedDate]
        FROM
          [Audit].[AuditAWBuildVersion] AS [AuditAWBuildVersion] WITH(NOLOCK)
        WHERE
          [AuditAWBuildVersion].[AuditBatchId] = @_AuditBatchId;
...
EXEC dbo.uspDel_AWBuildVersionByUuid
  @Uuid = @Uuid,
...
SELECT AuditAWBuildVersion.*
FROM   Audit.AuditAWBuildVersion AS AuditAWBuildVersion WITH(NOLOCK)
WHERE
  AuditAWBuildVersion.AuditBatchId = @AuditBatchId
;
...
EXECUTE sp_addextendedproperty
  ...
  @level1name = N'uspDel_AWBuildVersionByUuid';
GO