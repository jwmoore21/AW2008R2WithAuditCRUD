/*
IF EXISTS (SELECT 1 FROM [sys].[objects] WHERE object_id = OBJECT_ID(N'[dbo].[uspDel_DatabaseLogWithAudit]') AND type in (N'P', N'PC'))
DROP PROCEDURE [dbo].[uspDel_DatabaseLogWithAudit]
GO
*/

CREATE PROCEDURE [dbo].[uspDel_DatabaseLogWithAudit]
  @DatabaseLogID INT,
...
================================================================================
Schema:      dbo
Object:      uspDel_DatabaseLogWithAudit
...
BEGIN
  ...
  BEGIN TRY
    ...
    SET @_AuditOperation = COALESCE( @AuditOperation, 'Delete proc ran: uspDel_DatabaseLogWithAudit' );
...
EXEC dbo.uspDel_DatabaseLogWithAudit
...
EXECUTE sp_addextendedproperty
  ...
  @level1name = N'uspDel_DatabaseLogWithAudit';
GO