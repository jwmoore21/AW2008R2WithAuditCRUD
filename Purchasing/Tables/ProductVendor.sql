...
/* Defaults */
ALTER TABLE [Purchasing].[ProductVendor] ADD CONSTRAINT [DF__ProductVendor__RowStatus] DEFAULT ((1)) FOR [RowStatus]
GO

ALTER TABLE [Purchasing].[ProductVendor] ADD CONSTRAINT [DF__ProductVendor__CreatedBy] DEFAULT ('4E3A7D6D-8351-8494-FDB7-39E2A3A2E972') FOR [CreatedBy]
GO

ALTER TABLE [Purchasing].[ProductVendor] ADD CONSTRAINT [DF__ProductVendor__ModifiedBy] DEFAULT ('4E3A7D6D-8351-8494-FDB7-39E2A3A2E972') FOR [ModifiedBy]
GO

ALTER TABLE [Purchasing].[ProductVendor] ADD CONSTRAINT [DF__ProductVendor__CreatedDate] DEFAULT (GETUTCDATE()) FOR [CreatedDate]
GO

ALTER TABLE [Purchasing].[ProductVendor] ADD CONSTRAINT [DF__ProductVendor__ModifiedDate] DEFAULT (GETUTCDATE()) FOR [ModifiedDate]
GO

ALTER TABLE [Purchasing].[ProductVendor] ADD CONSTRAINT [DF__ProductVendor__Uuid] DEFAULT (NEWID()) FOR [Uuid]
GO
...
GO
EXECUTE sp_addextendedproperty @name = N'MS_Description', @value = N'Default constraint value of GETDATE()', @level0type = N'SCHEMA', @level0name = N'Purchasing', @level1type = N'TABLE', @level1name = N'ProductVendor', @level2type = N'CONSTRAINT', @level2name = N'DF__ProductVendor__ModifiedDate';
