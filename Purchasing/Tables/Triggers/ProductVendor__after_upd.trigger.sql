/*
IF EXISTS ( SELECT 1 FROM sys.triggers WHERE object_id = object_id(N'[Purchasing].[TRG__ProductVendor__after_upd]'))
DROP TRIGGER [Purchasing].[TRG__ProductVendor__after_upd]
GO
*/
CREATE TRIGGER [Purchasing].[TRG__ProductVendor__after_upd] ON [Purchasing].[ProductVendor]
  AFTER UPDATE
AS

/*******************************************************************************
Schema:      Purchasing
Object:      TRG__ProductVendor__after_upd
...
BEGIN
  ...
  BEGIN TRY
    ...
    SET @_AuditOperation = 'Autosave by: AFTER UPDATE Trigger : TRG__ProductVendor__after_upd';
    /* ========================================================================= */
    ...
    /* Insert into a TEMP table, all of our deleted values */
    INSERT INTO [Audit].[AuditProductVendor]
    (
       [AuditStatus]
      ,[AuditAppUser]
      ,[AuditSqlUser]
    ...
    SELECT
      ...
      ,[AuditRecordsToSave].[AverageLeadTime]
      ,[AuditRecordsToSave].[StandardPrice]
      ,[AuditRecordsToSave].[LastReceiptCost]
      ,[AuditRecordsToSave].[LastReceiptDate]
      ,[AuditRecordsToSave].[MinOrderQty]
      ,[AuditRecordsToSave].[MaxOrderQty]
      ,[AuditRecordsToSave].[OnOrderQty]
