/*
IF EXISTS ( SELECT 1 FROM sys.triggers WHERE object_id = object_id(N'[Purchasing].[TRG__ShipMethod__instead_of_del]'))
DROP TRIGGER [Purchasing].[TRG__ShipMethod__instead_of_del]
GO
*/
CREATE TRIGGER [Purchasing].[TRG__ShipMethod__instead_of_del] ON [Purchasing].[ShipMethod]
  INSTEAD OF DELETE
AS

/*******************************************************************************
Schema:      Purchasing
Object:      TRG__ShipMethod__instead_of_del
...
BEGIN
  ...
  BEGIN TRY
    ...
    SET @_AuditOperation = 'Autosave by: INSTEAD OF DELETE Trigger : TRG__ShipMethod__instead_of_del';
    ...
    FROM [Purchasing].[ShipMethod] AS recordsToErase
