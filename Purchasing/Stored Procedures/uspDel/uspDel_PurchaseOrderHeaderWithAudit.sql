/*
IF EXISTS (SELECT 1 FROM [sys].[objects] WHERE object_id = OBJECT_ID(N'[Purchasing].[uspDel_PurchaseOrderHeaderWithAudit]') AND type in (N'P', N'PC'))
DROP PROCEDURE [Purchasing].[uspDel_PurchaseOrderHeaderWithAudit]
GO
*/

CREATE PROCEDURE [Purchasing].[uspDel_PurchaseOrderHeaderWithAudit]
  @PurchaseOrderID INT,
...
================================================================================
Schema:      Purchasing
Object:      uspDel_PurchaseOrderHeaderWithAudit
...
BEGIN
  ...
  BEGIN TRY
    ...
    SET @_AuditOperation = COALESCE( @AuditOperation, 'Delete proc ran: uspDel_PurchaseOrderHeaderWithAudit' );
...
EXEC Purchasing.uspDel_PurchaseOrderHeaderWithAudit
...
EXECUTE sp_addextendedproperty
  ...
  @level1name = N'uspDel_PurchaseOrderHeaderWithAudit';
GO