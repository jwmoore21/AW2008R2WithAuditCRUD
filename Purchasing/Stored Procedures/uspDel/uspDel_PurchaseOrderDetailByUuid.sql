/*
IF EXISTS (SELECT 1 FROM [sys].[objects] WHERE object_id = OBJECT_ID(N'[Purchasing].[uspDel_PurchaseOrderDetailByUuid]') AND type in (N'P', N'PC'))
DROP PROCEDURE [Purchasing].[uspDel_PurchaseOrderDetailByUuid]
GO
*/

CREATE PROCEDURE [Purchasing].[uspDel_PurchaseOrderDetailByUuid]
...
================================================================================
Schema:      Purchasing
Object:      uspDel_PurchaseOrderDetailByUuid
...
BEGIN
  ...
  BEGIN TRY
    ...
    SET @_AuditOperation = COALESCE( @AuditOperation, 'Delete proc ran: uspDel_PurchaseOrderDetailByUuid' );
    ...
    BEGIN
      ...
      WHERE
        [PurchaseOrderDetail].[Uuid] = @_Uuid
      ;
...
EXEC Purchasing.uspDel_PurchaseOrderDetailByUuid
  @Uuid = @Uuid,
...
EXECUTE sp_addextendedproperty
  ...
  @level1name = N'uspDel_PurchaseOrderDetailByUuid';
GO