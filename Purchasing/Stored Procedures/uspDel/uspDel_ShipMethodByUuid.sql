/*
IF EXISTS (SELECT 1 FROM [sys].[objects] WHERE object_id = OBJECT_ID(N'[Purchasing].[uspDel_ShipMethodByUuid]') AND type in (N'P', N'PC'))
DROP PROCEDURE [Purchasing].[uspDel_ShipMethodByUuid]
GO
*/

CREATE PROCEDURE [Purchasing].[uspDel_ShipMethodByUuid]
...
================================================================================
Schema:      Purchasing
Object:      uspDel_ShipMethodByUuid
...
BEGIN
  ...
  BEGIN TRY
    ...
    SET @_AuditOperation = COALESCE( @AuditOperation, 'Delete proc ran: uspDel_ShipMethodByUuid' );
...
EXEC Purchasing.uspDel_ShipMethodByUuid
  @Uuid = @Uuid,
...
EXECUTE sp_addextendedproperty
  ...
  @level1name = N'uspDel_ShipMethodByUuid';
GO