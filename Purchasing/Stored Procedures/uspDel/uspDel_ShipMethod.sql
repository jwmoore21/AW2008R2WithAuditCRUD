/*
IF EXISTS (SELECT 1 FROM [sys].[objects] WHERE object_id = OBJECT_ID(N'[Purchasing].[uspDel_ShipMethod]') AND type in (N'P', N'PC'))
DROP PROCEDURE [Purchasing].[uspDel_ShipMethod]
GO
*/

CREATE PROCEDURE [Purchasing].[uspDel_ShipMethod]
  @ShipMethodID INT,
    ...
    BEGIN
      ...
      BEGIN
        ...
        SELECT
          ...
          ,[OutputTableVar].[Name]
          ,[OutputTableVar].[ShipBase]
          ,[OutputTableVar].[ShipRate]
...
EXEC Purchasing.uspDel_ShipMethod
...
EXECUTE sp_addextendedproperty
  ...
  @level1name = N'uspDel_ShipMethod';
GO