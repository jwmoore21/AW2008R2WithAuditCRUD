/*
IF EXISTS (SELECT 1 FROM [sys].[objects] WHERE object_id = OBJECT_ID(N'[Purchasing].[uspDel_ProductVendorByUuid]') AND type in (N'P', N'PC'))
DROP PROCEDURE [Purchasing].[uspDel_ProductVendorByUuid]
GO
*/

CREATE PROCEDURE [Purchasing].[uspDel_ProductVendorByUuid]
...
================================================================================
Schema:      Purchasing
Object:      uspDel_ProductVendorByUuid
...
BEGIN
  ...
  BEGIN TRY
    ...
    SET @_AuditOperation = COALESCE( @AuditOperation, 'Delete proc ran: uspDel_ProductVendorByUuid' );
...
EXEC Purchasing.uspDel_ProductVendorByUuid
  @Uuid = @Uuid,
...
EXECUTE sp_addextendedproperty
  ...
  @level1name = N'uspDel_ProductVendorByUuid';
GO