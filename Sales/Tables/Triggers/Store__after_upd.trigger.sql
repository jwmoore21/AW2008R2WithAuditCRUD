/*
IF EXISTS ( SELECT 1 FROM sys.triggers WHERE object_id = object_id(N'[Sales].[TRG__Store__after_upd]'))
DROP TRIGGER [Sales].[TRG__Store__after_upd]
GO
*/
CREATE TRIGGER [Sales].[TRG__Store__after_upd] ON [Sales].[Store]
  AFTER UPDATE
AS

/*******************************************************************************
Schema:      Sales
Object:      TRG__Store__after_upd
...
BEGIN
  ...
  BEGIN TRY
    ...
    SET @_AuditOperation = 'Autosave by: AFTER UPDATE Trigger : TRG__Store__after_upd';
    /* ========================================================================= */
