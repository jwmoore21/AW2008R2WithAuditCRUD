/*
IF EXISTS ( SELECT 1 FROM sys.triggers WHERE object_id = object_id(N'[Sales].[TRG__PersonCreditCard__instead_of_del]'))
DROP TRIGGER [Sales].[TRG__PersonCreditCard__instead_of_del]
GO
*/
CREATE TRIGGER [Sales].[TRG__PersonCreditCard__instead_of_del] ON [Sales].[PersonCreditCard]
  INSTEAD OF DELETE
AS

/*******************************************************************************
Schema:      Sales
Object:      TRG__PersonCreditCard__instead_of_del
...
BEGIN
  ...
  BEGIN TRY
    ...
    SET @_AuditOperation = 'Autosave by: INSTEAD OF DELETE Trigger : TRG__PersonCreditCard__instead_of_del';
    ...
    FROM [Sales].[PersonCreditCard] AS recordsToErase
