/*
IF EXISTS (SELECT 1 FROM [sys].[objects] WHERE object_id = OBJECT_ID(N'[Sales].[uspDel_countryregioncurrency]') AND type in (N'P', N'PC'))
DROP PROCEDURE [Sales].[uspDel_countryregioncurrency]
GO
*/

CREATE PROCEDURE [Sales].[uspDel_countryregioncurrency]
...
================================================================================
Schema:      Sales
Object:      uspDel_countryregioncurrency
...
EXEC Sales.uspDel_countryregioncurrency
...
EXECUTE sp_addextendedproperty
  ...
  @level1name = N'uspDel_countryregioncurrency';
GO