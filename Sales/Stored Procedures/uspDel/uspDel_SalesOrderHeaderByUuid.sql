/*
IF EXISTS (SELECT 1 FROM [sys].[objects] WHERE object_id = OBJECT_ID(N'[Sales].[uspDel_SalesOrderHeaderByUuid]') AND type in (N'P', N'PC'))
DROP PROCEDURE [Sales].[uspDel_SalesOrderHeaderByUuid]
GO
*/

CREATE PROCEDURE [Sales].[uspDel_SalesOrderHeaderByUuid]
...
================================================================================
Schema:      Sales
Object:      uspDel_SalesOrderHeaderByUuid
...
BEGIN
  ...
  BEGIN TRY
    ...
    SET @_AuditOperation = COALESCE( @AuditOperation, 'Delete proc ran: uspDel_SalesOrderHeaderByUuid' );
...
EXEC Sales.uspDel_SalesOrderHeaderByUuid
  @Uuid = @Uuid,
...
EXECUTE sp_addextendedproperty
  ...
  @level1name = N'uspDel_SalesOrderHeaderByUuid';
GO