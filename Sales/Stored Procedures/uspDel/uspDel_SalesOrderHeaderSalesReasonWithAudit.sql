/*
IF EXISTS (SELECT 1 FROM [sys].[objects] WHERE object_id = OBJECT_ID(N'[Sales].[uspDel_SalesOrderHeaderSalesReasonWithAudit]') AND type in (N'P', N'PC'))
DROP PROCEDURE [Sales].[uspDel_SalesOrderHeaderSalesReasonWithAudit]
GO
*/

CREATE PROCEDURE [Sales].[uspDel_SalesOrderHeaderSalesReasonWithAudit]
  @SalesOrderID INT,
  @SalesReasonID INT,
...
================================================================================
Schema:      Sales
Object:      uspDel_SalesOrderHeaderSalesReasonWithAudit
...
BEGIN
  ...
  BEGIN TRY
    ...
    SET @_AuditOperation = COALESCE( @AuditOperation, 'Delete proc ran: uspDel_SalesOrderHeaderSalesReasonWithAudit' );
...
EXEC Sales.uspDel_SalesOrderHeaderSalesReasonWithAudit
...
EXECUTE sp_addextendedproperty
  ...
  @level1name = N'uspDel_SalesOrderHeaderSalesReasonWithAudit';
GO