/*
IF EXISTS (SELECT 1 FROM [sys].[objects] WHERE object_id = OBJECT_ID(N'[Sales].[uspDel_SpecialOfferByUuid]') AND type in (N'P', N'PC'))
DROP PROCEDURE [Sales].[uspDel_SpecialOfferByUuid]
GO
*/

CREATE PROCEDURE [Sales].[uspDel_SpecialOfferByUuid]
...
================================================================================
Schema:      Sales
Object:      uspDel_SpecialOfferByUuid
...
BEGIN
  ...
  BEGIN TRY
    ...
    SET @_AuditOperation = COALESCE( @AuditOperation, 'Delete proc ran: uspDel_SpecialOfferByUuid' );
...
EXEC Sales.uspDel_SpecialOfferByUuid
  @Uuid = @Uuid,
...
EXECUTE sp_addextendedproperty
  ...
  @level1name = N'uspDel_SpecialOfferByUuid';
GO