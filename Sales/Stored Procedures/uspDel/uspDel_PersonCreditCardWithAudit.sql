/*
IF EXISTS (SELECT 1 FROM [sys].[objects] WHERE object_id = OBJECT_ID(N'[Sales].[uspDel_PersonCreditCardWithAudit]') AND type in (N'P', N'PC'))
DROP PROCEDURE [Sales].[uspDel_PersonCreditCardWithAudit]
GO
*/

CREATE PROCEDURE [Sales].[uspDel_PersonCreditCardWithAudit]
...
================================================================================
Schema:      Sales
Object:      uspDel_PersonCreditCardWithAudit
...
BEGIN
  ...
  BEGIN TRY
    ...
    SET @_AuditOperation = COALESCE( @AuditOperation, 'Delete proc ran: uspDel_PersonCreditCardWithAudit' );
...
EXEC Sales.uspDel_PersonCreditCardWithAudit
...
EXECUTE sp_addextendedproperty
  ...
  @level1name = N'uspDel_PersonCreditCardWithAudit';
GO