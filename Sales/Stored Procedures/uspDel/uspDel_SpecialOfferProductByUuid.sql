/*
IF EXISTS (SELECT 1 FROM [sys].[objects] WHERE object_id = OBJECT_ID(N'[Sales].[uspDel_SpecialOfferProductByUuid]') AND type in (N'P', N'PC'))
DROP PROCEDURE [Sales].[uspDel_SpecialOfferProductByUuid]
GO
*/

CREATE PROCEDURE [Sales].[uspDel_SpecialOfferProductByUuid]
...
================================================================================
Schema:      Sales
Object:      uspDel_SpecialOfferProductByUuid
...
BEGIN
  ...
  BEGIN TRY
    ...
    SET @_AuditOperation = COALESCE( @AuditOperation, 'Delete proc ran: uspDel_SpecialOfferProductByUuid' );
    ...
    BEGIN
      ...
      WHERE
        [SpecialOfferProduct].[Uuid] = @_Uuid
      ;
...
EXEC Sales.uspDel_SpecialOfferProductByUuid
  @Uuid = @Uuid,
...
EXECUTE sp_addextendedproperty
  ...
  @level1name = N'uspDel_SpecialOfferProductByUuid';
GO