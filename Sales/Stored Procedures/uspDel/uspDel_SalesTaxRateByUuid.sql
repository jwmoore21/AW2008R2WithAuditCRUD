/*
IF EXISTS (SELECT 1 FROM [sys].[objects] WHERE object_id = OBJECT_ID(N'[Sales].[uspDel_SalesTaxRateByUuid]') AND type in (N'P', N'PC'))
DROP PROCEDURE [Sales].[uspDel_SalesTaxRateByUuid]
GO
*/

CREATE PROCEDURE [Sales].[uspDel_SalesTaxRateByUuid]
...
================================================================================
Schema:      Sales
Object:      uspDel_SalesTaxRateByUuid
...
BEGIN
  ...
  BEGIN TRY
    ...
    SET @_AuditOperation = COALESCE( @AuditOperation, 'Delete proc ran: uspDel_SalesTaxRateByUuid' );
    ...
    (
      ...
      AND [tables].[name] = 'AuditSalesTaxRate'
    );
    ...
    (
      ...
      AND OBJECT_NAME([so].[parent_obj]) = 'SalesTaxRate'
    ...
    FROM
      [Audit].[AuditSalesTaxRate] AS [AuditSalesTaxRate] WITH(NOLOCK)
    WHERE
      [AuditSalesTaxRate].[AuditBatchId] = @_AuditBatchId;
    ...
    BEGIN
      ...
      BEGIN
        ...
        SELECT
           [AuditSalesTaxRate].[SalesTaxRateID]
          ,[AuditSalesTaxRate].[StateProvinceID]
          ,[AuditSalesTaxRate].[TaxType]
          ,[AuditSalesTaxRate].[TaxRate]
          ,[AuditSalesTaxRate].[Name]
          ,[AuditSalesTaxRate].[rowguid]
          ,[AuditSalesTaxRate].[RowStatus]
          ,[AuditSalesTaxRate].[CreatedBy]
          ,[AuditSalesTaxRate].[ModifiedBy]
          ,[AuditSalesTaxRate].[CreatedDate]
          ,[AuditSalesTaxRate].[ModifiedDate]
          ,[AuditSalesTaxRate].[Uuid]
        FROM
          [Audit].[AuditSalesTaxRate] AS [AuditSalesTaxRate] WITH(NOLOCK)
        WHERE
          [AuditSalesTaxRate].[AuditBatchId] = @_AuditBatchId;
...
EXEC Sales.uspDel_SalesTaxRateByUuid
  @Uuid = @Uuid,
...
SELECT AuditSalesTaxRate.*
FROM   Audit.AuditSalesTaxRate AS AuditSalesTaxRate WITH(NOLOCK)
WHERE
  AuditSalesTaxRate.AuditBatchId = @AuditBatchId
;
...
EXECUTE sp_addextendedproperty
  ...
  @level1name = N'uspDel_SalesTaxRateByUuid';
GO