/*
IF EXISTS (SELECT 1 FROM [sys].[objects] WHERE object_id = OBJECT_ID(N'[Sales].[uspDel_SalesTerritoryWithAudit]') AND type in (N'P', N'PC'))
DROP PROCEDURE [Sales].[uspDel_SalesTerritoryWithAudit]
GO
*/

CREATE PROCEDURE [Sales].[uspDel_SalesTerritoryWithAudit]
  @TerritoryID INT,
...
================================================================================
Schema:      Sales
Object:      uspDel_SalesTerritoryWithAudit
...
BEGIN
  ...
  BEGIN TRY
    ...
    SET @_AuditOperation = COALESCE( @AuditOperation, 'Delete proc ran: uspDel_SalesTerritoryWithAudit' );
    ...
    (
      ...
      AND OBJECT_NAME([so].[parent_obj]) = 'SalesTerritory'
      ...
      (
        ...
        AND [tables].[name] = 'AuditSalesTerritory'
      ) = 1
    ) = 1
    BEGIN
      ...
      WHERE
        [SalesTerritory].[TerritoryID] = @_TerritoryID
      ;
    ...
    FROM
      [Audit].[AuditSalesTerritory] AS [AuditSalesTerritory] WITH(NOLOCK)
    WHERE
      [AuditSalesTerritory].[AuditBatchId] = @_AuditBatchId;
    ...
    BEGIN
      ...
      BEGIN
        ...
        SELECT
           [AuditSalesTerritory].[TerritoryID]
          ,[AuditSalesTerritory].[Name]
          ,[AuditSalesTerritory].[CountryRegionCode]
          ,[AuditSalesTerritory].[Group]
          ,[AuditSalesTerritory].[SalesYTD]
          ,[AuditSalesTerritory].[SalesLastYear]
          ,[AuditSalesTerritory].[CostYTD]
          ,[AuditSalesTerritory].[CostLastYear]
          ,[AuditSalesTerritory].[rowguid]
          ,[AuditSalesTerritory].[RowStatus]
          ,[AuditSalesTerritory].[CreatedBy]
          ,[AuditSalesTerritory].[ModifiedBy]
          ,[AuditSalesTerritory].[CreatedDate]
          ,[AuditSalesTerritory].[ModifiedDate]
          ,[AuditSalesTerritory].[Uuid]
        FROM
          [Audit].[AuditSalesTerritory] AS [AuditSalesTerritory] WITH(NOLOCK)
        WHERE
          [AuditSalesTerritory].[AuditBatchId] = @_AuditBatchId;
        ...
        BEGIN TRY
          SELECT
            ...
            (
              ...
              WHERE
                [AuditSalesTerritory].[AuditBatchId] = @_AuditBatchId
              FOR XML PATH ('SalesTerritory'), ROOT ('DeletedRecords'), ELEMENTS XSINIL
            );
...
EXEC Sales.uspDel_SalesTerritoryWithAudit
...
SELECT AuditSalesTerritory.*
FROM   Audit.AuditSalesTerritory AS AuditSalesTerritory WITH(NOLOCK)
WHERE
  AuditSalesTerritory.AuditBatchId = @AuditBatchId
;
...
EXECUTE sp_addextendedproperty
  ...
  @level1name = N'uspDel_SalesTerritoryWithAudit';
GO