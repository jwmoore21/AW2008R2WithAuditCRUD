/*
IF EXISTS (SELECT 1 FROM [sys].[objects] WHERE object_id = OBJECT_ID(N'[Sales].[uspDel_SalesReasonByUuid]') AND type in (N'P', N'PC'))
DROP PROCEDURE [Sales].[uspDel_SalesReasonByUuid]
GO
*/

CREATE PROCEDURE [Sales].[uspDel_SalesReasonByUuid]
...
================================================================================
Schema:      Sales
Object:      uspDel_SalesReasonByUuid
...
BEGIN
  ...
  BEGIN TRY
    ...
    SET @_AuditOperation = COALESCE( @AuditOperation, 'Delete proc ran: uspDel_SalesReasonByUuid' );
...
EXEC Sales.uspDel_SalesReasonByUuid
  @Uuid = @Uuid,
...
EXECUTE sp_addextendedproperty
  ...
  @level1name = N'uspDel_SalesReasonByUuid';
GO