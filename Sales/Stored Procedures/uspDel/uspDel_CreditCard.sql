/*
IF EXISTS (SELECT 1 FROM [sys].[objects] WHERE object_id = OBJECT_ID(N'[Sales].[uspDel_CreditCard]') AND type in (N'P', N'PC'))
DROP PROCEDURE [Sales].[uspDel_CreditCard]
GO
*/

CREATE PROCEDURE [Sales].[uspDel_CreditCard]
  @CreditCardID INT,
    ...
    BEGIN
      ...
      BEGIN
        ...
        SELECT
          ...
          ,[OutputTableVar].[CardType]
          ,[OutputTableVar].[CardNumber]
          ,[OutputTableVar].[ExpMonth]
          ,[OutputTableVar].[ExpYear]
...
EXECUTE sp_addextendedproperty
  ...
  @level1name = N'uspDel_CreditCard';
GO