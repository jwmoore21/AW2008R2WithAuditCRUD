/*
IF EXISTS (SELECT 1 FROM [sys].[objects] WHERE object_id = OBJECT_ID(N'[Sales].[uspDel_SalesOrderHeaderWithAudit]') AND type in (N'P', N'PC'))
DROP PROCEDURE [Sales].[uspDel_SalesOrderHeaderWithAudit]
GO
*/

CREATE PROCEDURE [Sales].[uspDel_SalesOrderHeaderWithAudit]
  @SalesOrderID INT,
...
================================================================================
Schema:      Sales
Object:      uspDel_SalesOrderHeaderWithAudit
...
BEGIN
  ...
  BEGIN TRY
    ...
    SET @_AuditOperation = COALESCE( @AuditOperation, 'Delete proc ran: uspDel_SalesOrderHeaderWithAudit' );
    ...
    (
      ...
      AND OBJECT_NAME([so].[parent_obj]) = 'SalesOrderHeader'
      ...
      (
        ...
        AND [tables].[name] = 'AuditSalesOrderHeader'
      ) = 1
    ) = 1
    BEGIN
      ...
      WHERE
        [SalesOrderHeader].[SalesOrderID] = @_SalesOrderID
      ;
    ...
    BEGIN
      ...
      BEGIN
        ...
        OUTPUT
          ...
          [DELETED].[ShipToAddressID],
          [DELETED].[ShipMethodID],
          [DELETED].[CreditCardID],
          [DELETED].[CreditCardApprovalCode],
          [DELETED].[CurrencyRateID],
          [DELETED].[SubTotal],
          [DELETED].[TaxAmt],
          [DELETED].[Freight],
          [DELETED].[TotalDue],
    ...
    FROM
      [Audit].[AuditSalesOrderHeader] AS [AuditSalesOrderHeader] WITH(NOLOCK)
    WHERE
      [AuditSalesOrderHeader].[AuditBatchId] = @_AuditBatchId;
    ...
    BEGIN
      ...
      BEGIN
        ...
        SELECT
           [AuditSalesOrderHeader].[SalesOrderID]
          ,[AuditSalesOrderHeader].[RevisionNumber]
          ,[AuditSalesOrderHeader].[OrderDate]
          ,[AuditSalesOrderHeader].[DueDate]
          ,[AuditSalesOrderHeader].[ShipDate]
          ,[AuditSalesOrderHeader].[Status]
          ,[AuditSalesOrderHeader].[OnlineOrderFlag]
          ,[AuditSalesOrderHeader].[SalesOrderNumber]
          ,[AuditSalesOrderHeader].[PurchaseOrderNumber]
          ,[AuditSalesOrderHeader].[AccountNumber]
          ,[AuditSalesOrderHeader].[CustomerID]
          ,[AuditSalesOrderHeader].[SalesPersonID]
          ,[AuditSalesOrderHeader].[TerritoryID]
          ,[AuditSalesOrderHeader].[BillToAddressID]
          ,[AuditSalesOrderHeader].[ShipToAddressID]
          ,[AuditSalesOrderHeader].[ShipMethodID]
          ,[AuditSalesOrderHeader].[CreditCardID]
          ,[AuditSalesOrderHeader].[CreditCardApprovalCode]
          ,[AuditSalesOrderHeader].[CurrencyRateID]
          ,[AuditSalesOrderHeader].[SubTotal]
          ,[AuditSalesOrderHeader].[TaxAmt]
          ,[AuditSalesOrderHeader].[Freight]
          ,[AuditSalesOrderHeader].[TotalDue]
          ,[AuditSalesOrderHeader].[Comment]
          ,[AuditSalesOrderHeader].[rowguid]
          ,[AuditSalesOrderHeader].[RowStatus]
          ,[AuditSalesOrderHeader].[CreatedBy]
          ,[AuditSalesOrderHeader].[ModifiedBy]
          ,[AuditSalesOrderHeader].[CreatedDate]
          ,[AuditSalesOrderHeader].[ModifiedDate]
          ,[AuditSalesOrderHeader].[Uuid]
        FROM
          [Audit].[AuditSalesOrderHeader] AS [AuditSalesOrderHeader] WITH(NOLOCK)
        WHERE
          [AuditSalesOrderHeader].[AuditBatchId] = @_AuditBatchId;
        ...
        BEGIN TRY
          SELECT
            ...
            (
              ...
              WHERE
                [AuditSalesOrderHeader].[AuditBatchId] = @_AuditBatchId
              FOR XML PATH ('SalesOrderHeader'), ROOT ('DeletedRecords'), ELEMENTS XSINIL
            );
...
EXEC Sales.uspDel_SalesOrderHeaderWithAudit
...
SELECT AuditSalesOrderHeader.*
FROM   Audit.AuditSalesOrderHeader AS AuditSalesOrderHeader WITH(NOLOCK)
WHERE
  AuditSalesOrderHeader.AuditBatchId = @AuditBatchId
;
...
EXECUTE sp_addextendedproperty
  ...
  @level1name = N'uspDel_SalesOrderHeaderWithAudit';
GO