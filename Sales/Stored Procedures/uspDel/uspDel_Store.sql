/*
IF EXISTS (SELECT 1 FROM [sys].[objects] WHERE object_id = OBJECT_ID(N'[Sales].[uspDel_store]') AND type in (N'P', N'PC'))
DROP PROCEDURE [Sales].[uspDel_store]
GO
*/

CREATE PROCEDURE [Sales].[uspDel_store]
