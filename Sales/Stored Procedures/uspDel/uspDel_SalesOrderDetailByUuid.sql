/*
IF EXISTS (SELECT 1 FROM [sys].[objects] WHERE object_id = OBJECT_ID(N'[Sales].[uspDel_SalesOrderDetailByUuid]') AND type in (N'P', N'PC'))
DROP PROCEDURE [Sales].[uspDel_SalesOrderDetailByUuid]
GO
*/

CREATE PROCEDURE [Sales].[uspDel_SalesOrderDetailByUuid]
...
================================================================================
Schema:      Sales
Object:      uspDel_SalesOrderDetailByUuid
...
BEGIN
  ...
  BEGIN TRY
    ...
    SET @_AuditOperation = COALESCE( @AuditOperation, 'Delete proc ran: uspDel_SalesOrderDetailByUuid' );
    ...
    (
      ...
      AND [tables].[name] = 'AuditSalesOrderDetail'
    );
    ...
    (
      ...
      AND OBJECT_NAME([so].[parent_obj]) = 'SalesOrderDetail'
    ...
    FROM
      [Audit].[AuditSalesOrderDetail] AS [AuditSalesOrderDetail] WITH(NOLOCK)
    WHERE
      [AuditSalesOrderDetail].[AuditBatchId] = @_AuditBatchId;
    ...
    BEGIN
      ...
      BEGIN
        ...
        SELECT
           [AuditSalesOrderDetail].[SalesOrderID]
          ,[AuditSalesOrderDetail].[SalesOrderDetailID]
          ,[AuditSalesOrderDetail].[CustomerID]
          ,[AuditSalesOrderDetail].[CarrierTrackingNumber]
          ,[AuditSalesOrderDetail].[OrderQty]
          ,[AuditSalesOrderDetail].[ProductID]
          ,[AuditSalesOrderDetail].[SpecialOfferID]
          ,[AuditSalesOrderDetail].[UnitPrice]
          ,[AuditSalesOrderDetail].[UnitPriceDiscount]
          ,[AuditSalesOrderDetail].[LineTotal]
          ,[AuditSalesOrderDetail].[SubTotal]
          ,[AuditSalesOrderDetail].[rowguid]
          ,[AuditSalesOrderDetail].[RowStatus]
          ,[AuditSalesOrderDetail].[CreatedBy]
          ,[AuditSalesOrderDetail].[ModifiedBy]
          ,[AuditSalesOrderDetail].[CreatedDate]
          ,[AuditSalesOrderDetail].[ModifiedDate]
          ,[AuditSalesOrderDetail].[Uuid]
        FROM
          [Audit].[AuditSalesOrderDetail] AS [AuditSalesOrderDetail] WITH(NOLOCK)
        WHERE
          [AuditSalesOrderDetail].[AuditBatchId] = @_AuditBatchId;
...
EXEC Sales.uspDel_SalesOrderDetailByUuid
  @Uuid = @Uuid,
...
SELECT AuditSalesOrderDetail.*
FROM   Audit.AuditSalesOrderDetail AS AuditSalesOrderDetail WITH(NOLOCK)
WHERE
  AuditSalesOrderDetail.AuditBatchId = @AuditBatchId
;
...
EXECUTE sp_addextendedproperty
  ...
  @level1name = N'uspDel_SalesOrderDetailByUuid';
GO