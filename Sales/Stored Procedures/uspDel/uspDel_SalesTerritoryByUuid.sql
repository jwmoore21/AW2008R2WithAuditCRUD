/*
IF EXISTS (SELECT 1 FROM [sys].[objects] WHERE object_id = OBJECT_ID(N'[Sales].[uspDel_SalesTerritoryByUuid]') AND type in (N'P', N'PC'))
DROP PROCEDURE [Sales].[uspDel_SalesTerritoryByUuid]
GO
*/

CREATE PROCEDURE [Sales].[uspDel_SalesTerritoryByUuid]
...
================================================================================
Schema:      Sales
Object:      uspDel_SalesTerritoryByUuid
...
BEGIN
  ...
  BEGIN TRY
    ...
    SET @_AuditOperation = COALESCE( @AuditOperation, 'Delete proc ran: uspDel_SalesTerritoryByUuid' );
...
EXEC Sales.uspDel_SalesTerritoryByUuid
  @Uuid = @Uuid,
...
EXECUTE sp_addextendedproperty
  ...
  @level1name = N'uspDel_SalesTerritoryByUuid';
GO