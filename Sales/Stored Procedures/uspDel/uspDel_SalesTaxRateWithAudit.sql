/*
IF EXISTS (SELECT 1 FROM [sys].[objects] WHERE object_id = OBJECT_ID(N'[Sales].[uspDel_SalesTaxRateWithAudit]') AND type in (N'P', N'PC'))
DROP PROCEDURE [Sales].[uspDel_SalesTaxRateWithAudit]
GO
*/

CREATE PROCEDURE [Sales].[uspDel_SalesTaxRateWithAudit]
  @SalesTaxRateID INT,
...
================================================================================
Schema:      Sales
Object:      uspDel_SalesTaxRateWithAudit
...
BEGIN
  ...
  BEGIN TRY
    ...
    SET @_AuditOperation = COALESCE( @AuditOperation, 'Delete proc ran: uspDel_SalesTaxRateWithAudit' );
...
EXEC Sales.uspDel_SalesTaxRateWithAudit
...
EXECUTE sp_addextendedproperty
  ...
  @level1name = N'uspDel_SalesTaxRateWithAudit';
GO