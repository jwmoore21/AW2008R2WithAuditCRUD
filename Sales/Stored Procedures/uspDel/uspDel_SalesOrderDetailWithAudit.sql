/*
IF EXISTS (SELECT 1 FROM [sys].[objects] WHERE object_id = OBJECT_ID(N'[Sales].[uspDel_SalesOrderDetailWithAudit]') AND type in (N'P', N'PC'))
DROP PROCEDURE [Sales].[uspDel_SalesOrderDetailWithAudit]
GO
*/

CREATE PROCEDURE [Sales].[uspDel_SalesOrderDetailWithAudit]
  @SalesOrderID INT,
...
================================================================================
Schema:      Sales
Object:      uspDel_SalesOrderDetailWithAudit
...
BEGIN
  ...
  BEGIN TRY
    ...
    SET @_AuditOperation = COALESCE( @AuditOperation, 'Delete proc ran: uspDel_SalesOrderDetailWithAudit' );
...
EXEC Sales.uspDel_SalesOrderDetailWithAudit
...
EXECUTE sp_addextendedproperty
  ...
  @level1name = N'uspDel_SalesOrderDetailWithAudit';
GO