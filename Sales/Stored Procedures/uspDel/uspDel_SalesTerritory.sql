/*
IF EXISTS (SELECT 1 FROM [sys].[objects] WHERE object_id = OBJECT_ID(N'[Sales].[uspDel_salesterritory]') AND type in (N'P', N'PC'))
DROP PROCEDURE [Sales].[uspDel_salesterritory]
GO
*/

CREATE PROCEDURE [Sales].[uspDel_salesterritory]
  @TerritoryID INT,
    ...
    BEGIN
      ...
      BEGIN
        ...
        SELECT
          ...
          ,[OutputTableVar].[Group]
          ,[OutputTableVar].[SalesYTD]
          ,[OutputTableVar].[SalesLastYear]
          ,[OutputTableVar].[CostYTD]
          ,[OutputTableVar].[CostLastYear]
...
EXEC Sales.uspDel_salesterritory
...
EXECUTE sp_addextendedproperty
  ...
  @level1name = N'uspDel_salesterritory';
GO