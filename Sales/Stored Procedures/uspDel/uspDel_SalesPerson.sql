/*
IF EXISTS (SELECT 1 FROM [sys].[objects] WHERE object_id = OBJECT_ID(N'[Sales].[uspDel_salesperson]') AND type in (N'P', N'PC'))
DROP PROCEDURE [Sales].[uspDel_salesperson]
GO
*/

CREATE PROCEDURE [Sales].[uspDel_salesperson]
    ...
    BEGIN
      ...
      BEGIN
        ...
        SELECT
          ...
          ,[OutputTableVar].[SalesQuota]
          ,[OutputTableVar].[Bonus]
          ,[OutputTableVar].[CommissionPct]
...
EXECUTE sp_addextendedproperty
  ...
  @level1name = N'uspDel_salesperson';
GO