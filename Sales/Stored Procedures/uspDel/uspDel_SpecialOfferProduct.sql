/*
IF EXISTS (SELECT 1 FROM [sys].[objects] WHERE object_id = OBJECT_ID(N'[Sales].[uspDel_SpecialOfferProduct]') AND type in (N'P', N'PC'))
DROP PROCEDURE [Sales].[uspDel_SpecialOfferProduct]
GO
*/

CREATE PROCEDURE [Sales].[uspDel_SpecialOfferProduct]
  @SpecialOfferID INT,
  @ProductID INT,
...
================================================================================
Schema:      Sales
Object:      uspDel_SpecialOfferProduct
...
EXEC Sales.uspDel_SpecialOfferProduct
...
EXECUTE sp_addextendedproperty
  ...
  @level1name = N'uspDel_SpecialOfferProduct';
GO