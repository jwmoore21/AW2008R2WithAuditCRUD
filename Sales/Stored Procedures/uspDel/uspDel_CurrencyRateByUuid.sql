/*
IF EXISTS (SELECT 1 FROM [sys].[objects] WHERE object_id = OBJECT_ID(N'[Sales].[uspDel_CurrencyRateByUuid]') AND type in (N'P', N'PC'))
DROP PROCEDURE [Sales].[uspDel_CurrencyRateByUuid]
GO
*/

CREATE PROCEDURE [Sales].[uspDel_CurrencyRateByUuid]
...
================================================================================
Schema:      Sales
Object:      uspDel_CurrencyRateByUuid
...
BEGIN
  ...
  BEGIN TRY
    ...
    SET @_AuditOperation = COALESCE( @AuditOperation, 'Delete proc ran: uspDel_CurrencyRateByUuid' );
...
EXEC Sales.uspDel_CurrencyRateByUuid
  @Uuid = @Uuid,
...
EXECUTE sp_addextendedproperty
  ...
  @level1name = N'uspDel_CurrencyRateByUuid';
GO