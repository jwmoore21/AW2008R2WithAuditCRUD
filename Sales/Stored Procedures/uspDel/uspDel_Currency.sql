/*
IF EXISTS (SELECT 1 FROM [sys].[objects] WHERE object_id = OBJECT_ID(N'[Sales].[uspDel_Currency]') AND type in (N'P', N'PC'))
DROP PROCEDURE [Sales].[uspDel_Currency]
GO
*/

CREATE PROCEDURE [Sales].[uspDel_Currency]
