/*
IF EXISTS (SELECT 1 FROM [sys].[objects] WHERE object_id = OBJECT_ID(N'[Sales].[uspDel_customer]') AND type in (N'P', N'PC'))
DROP PROCEDURE [Sales].[uspDel_customer]
GO
*/

CREATE PROCEDURE [Sales].[uspDel_customer]
  @CustomerID INT,
