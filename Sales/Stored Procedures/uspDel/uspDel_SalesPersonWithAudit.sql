/*
IF EXISTS (SELECT 1 FROM [sys].[objects] WHERE object_id = OBJECT_ID(N'[Sales].[uspDel_SalesPersonWithAudit]') AND type in (N'P', N'PC'))
DROP PROCEDURE [Sales].[uspDel_SalesPersonWithAudit]
GO
*/

CREATE PROCEDURE [Sales].[uspDel_SalesPersonWithAudit]
...
================================================================================
Schema:      Sales
Object:      uspDel_SalesPersonWithAudit
...
BEGIN
  ...
  BEGIN TRY
    ...
    SET @_AuditOperation = COALESCE( @AuditOperation, 'Delete proc ran: uspDel_SalesPersonWithAudit' );
    ...
    (
      ...
      AND OBJECT_NAME([so].[parent_obj]) = 'SalesPerson'
      ...
      (
        ...
        AND [tables].[name] = 'AuditSalesPerson'
      ) = 1
    ) = 1
    BEGIN
      ...
      WHERE
        [salesperson].[BusinessEntityID] = @_BusinessEntityID
      ;
    ...
    FROM
      [Audit].[AuditSalesPerson] AS [AuditSalesPerson] WITH(NOLOCK)
    WHERE
      [AuditSalesPerson].[AuditBatchId] = @_AuditBatchId;
    ...
    BEGIN
      ...
      BEGIN
        ...
        SELECT
           [AuditSalesPerson].[BusinessEntityID]
          ,[AuditSalesPerson].[TerritoryID]
          ,[AuditSalesPerson].[SalesQuota]
          ,[AuditSalesPerson].[Bonus]
          ,[AuditSalesPerson].[CommissionPct]
          ,[AuditSalesPerson].[SalesYTD]
          ,[AuditSalesPerson].[SalesLastYear]
          ,[AuditSalesPerson].[rowguid]
          ,[AuditSalesPerson].[RowStatus]
          ,[AuditSalesPerson].[CreatedBy]
          ,[AuditSalesPerson].[ModifiedBy]
          ,[AuditSalesPerson].[CreatedDate]
          ,[AuditSalesPerson].[ModifiedDate]
          ,[AuditSalesPerson].[Uuid]
        FROM
          [Audit].[AuditSalesPerson] AS [AuditSalesPerson] WITH(NOLOCK)
        WHERE
          [AuditSalesPerson].[AuditBatchId] = @_AuditBatchId;
        ...
        BEGIN TRY
          SELECT
            ...
            (
              ...
              WHERE
                [AuditSalesPerson].[AuditBatchId] = @_AuditBatchId
              FOR XML PATH ('SalesPerson'), ROOT ('DeletedRecords'), ELEMENTS XSINIL
            );
...
EXEC Sales.uspDel_SalesPersonWithAudit
...
SELECT AuditSalesPerson.*
FROM   Audit.AuditSalesPerson AS AuditSalesPerson WITH(NOLOCK)
WHERE
  AuditSalesPerson.AuditBatchId = @AuditBatchId
;
...
EXECUTE sp_addextendedproperty
  ...
  @level1name = N'uspDel_SalesPersonWithAudit';
GO