/*
IF EXISTS (SELECT 1 FROM [sys].[objects] WHERE object_id = OBJECT_ID(N'[Sales].[uspDel_CreditCardByUuid]') AND type in (N'P', N'PC'))
DROP PROCEDURE [Sales].[uspDel_CreditCardByUuid]
GO
*/

CREATE PROCEDURE [Sales].[uspDel_CreditCardByUuid]
...
================================================================================
Schema:      Sales
Object:      uspDel_CreditCardByUuid
...
BEGIN
  ...
  BEGIN TRY
    ...
    SET @_AuditOperation = COALESCE( @AuditOperation, 'Delete proc ran: uspDel_CreditCardByUuid' );
...
EXEC Sales.uspDel_CreditCardByUuid
  @Uuid = @Uuid,
...
EXECUTE sp_addextendedproperty
  ...
  @level1name = N'uspDel_CreditCardByUuid';
GO