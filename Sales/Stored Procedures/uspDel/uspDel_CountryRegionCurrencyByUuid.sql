/*
IF EXISTS (SELECT 1 FROM [sys].[objects] WHERE object_id = OBJECT_ID(N'[Sales].[uspDel_CountryRegionCurrencyByUuid]') AND type in (N'P', N'PC'))
DROP PROCEDURE [Sales].[uspDel_CountryRegionCurrencyByUuid]
GO
*/

CREATE PROCEDURE [Sales].[uspDel_CountryRegionCurrencyByUuid]
...
================================================================================
Schema:      Sales
Object:      uspDel_CountryRegionCurrencyByUuid
...
BEGIN
  ...
  BEGIN TRY
    ...
    SET @_AuditOperation = COALESCE( @AuditOperation, 'Delete proc ran: uspDel_CountryRegionCurrencyByUuid' );
    ...
    BEGIN
      ...
      WHERE
        [CountryRegionCurrency].[Uuid] = @_Uuid
      ;
...
EXEC Sales.uspDel_CountryRegionCurrencyByUuid
  @Uuid = @Uuid,
...
EXECUTE sp_addextendedproperty
  ...
  @level1name = N'uspDel_CountryRegionCurrencyByUuid';
GO