/*
IF EXISTS (SELECT 1 FROM [sys].[objects] WHERE object_id = OBJECT_ID(N'[Sales].[uspDel_specialoffer]') AND type in (N'P', N'PC'))
DROP PROCEDURE [Sales].[uspDel_specialoffer]
GO
*/

CREATE PROCEDURE [Sales].[uspDel_specialoffer]
  @SpecialOfferID INT,
    ...
    BEGIN
      ...
      BEGIN
        ...
        SELECT
          ...
          ,[OutputTableVar].[DiscountPct]
          ,[OutputTableVar].[Type]
          ,[OutputTableVar].[Category]
          ,[OutputTableVar].[StartDate]
          ,[OutputTableVar].[EndDate]
          ,[OutputTableVar].[MinQty]
          ,[OutputTableVar].[MaxQty]
...
EXEC Sales.uspDel_specialoffer
...
EXECUTE sp_addextendedproperty
  ...
  @level1name = N'uspDel_specialoffer';
GO