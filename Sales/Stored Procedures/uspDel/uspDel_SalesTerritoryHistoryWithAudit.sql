/*
IF EXISTS (SELECT 1 FROM [sys].[objects] WHERE object_id = OBJECT_ID(N'[Sales].[uspDel_SalesTerritoryHistoryWithAudit]') AND type in (N'P', N'PC'))
DROP PROCEDURE [Sales].[uspDel_SalesTerritoryHistoryWithAudit]
GO
*/

CREATE PROCEDURE [Sales].[uspDel_SalesTerritoryHistoryWithAudit]
...
================================================================================
Schema:      Sales
Object:      uspDel_SalesTerritoryHistoryWithAudit
...
BEGIN
  ...
  BEGIN TRY
    ...
    SET @_AuditOperation = COALESCE( @AuditOperation, 'Delete proc ran: uspDel_SalesTerritoryHistoryWithAudit' );
...
EXEC Sales.uspDel_SalesTerritoryHistoryWithAudit
...
EXECUTE sp_addextendedproperty
  ...
  @level1name = N'uspDel_SalesTerritoryHistoryWithAudit';
GO