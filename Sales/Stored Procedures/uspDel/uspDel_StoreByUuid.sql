/*
IF EXISTS (SELECT 1 FROM [sys].[objects] WHERE object_id = OBJECT_ID(N'[Sales].[uspDel_StoreByUuid]') AND type in (N'P', N'PC'))
DROP PROCEDURE [Sales].[uspDel_StoreByUuid]
GO
*/

CREATE PROCEDURE [Sales].[uspDel_StoreByUuid]
...
BEGIN
  ...
  BEGIN TRY
    ...
    SET @_AuditOperation = COALESCE( @AuditOperation, 'Delete proc ran: uspDel_StoreByUuid' );
...
EXECUTE sp_addextendedproperty
  ...
  @level1name = N'uspDel_StoreByUuid';
GO