/*
IF EXISTS (SELECT 1 FROM [sys].[objects] WHERE object_id = OBJECT_ID(N'[Sales].[uspDel_SalesPersonByUuid]') AND type in (N'P', N'PC'))
DROP PROCEDURE [Sales].[uspDel_SalesPersonByUuid]
GO
*/

CREATE PROCEDURE [Sales].[uspDel_SalesPersonByUuid]
...
================================================================================
Schema:      Sales
Object:      uspDel_SalesPersonByUuid
...
BEGIN
  ...
  BEGIN TRY
    ...
    SET @_AuditOperation = COALESCE( @AuditOperation, 'Delete proc ran: uspDel_SalesPersonByUuid' );
...
EXEC Sales.uspDel_SalesPersonByUuid
  @Uuid = @Uuid,
...
EXECUTE sp_addextendedproperty
  ...
  @level1name = N'uspDel_SalesPersonByUuid';
GO