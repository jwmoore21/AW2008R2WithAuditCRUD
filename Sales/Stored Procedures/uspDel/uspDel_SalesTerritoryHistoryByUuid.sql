/*
IF EXISTS (SELECT 1 FROM [sys].[objects] WHERE object_id = OBJECT_ID(N'[Sales].[uspDel_SalesTerritoryHistoryByUuid]') AND type in (N'P', N'PC'))
DROP PROCEDURE [Sales].[uspDel_SalesTerritoryHistoryByUuid]
GO
*/

CREATE PROCEDURE [Sales].[uspDel_SalesTerritoryHistoryByUuid]
...
================================================================================
Schema:      Sales
Object:      uspDel_SalesTerritoryHistoryByUuid
...
BEGIN
  ...
  BEGIN TRY
    ...
    SET @_AuditOperation = COALESCE( @AuditOperation, 'Delete proc ran: uspDel_SalesTerritoryHistoryByUuid' );
    ...
    (
      ...
      AND [tables].[name] = 'AuditSalesTerritoryHistory'
    );
    ...
    (
      ...
      AND OBJECT_NAME([so].[parent_obj]) = 'SalesTerritoryHistory'
    ...
    BEGIN
      ...
      WHERE
        [SalesTerritoryHistory].[Uuid] = @_Uuid
      ;
    ...
    BEGIN
      ...
      BEGIN
        ...
        INTO
          [Audit].[AuditSalesTerritoryHistory]
    ...
    FROM
      [Audit].[AuditSalesTerritoryHistory] AS [AuditSalesTerritoryHistory] WITH(NOLOCK)
    WHERE
      [AuditSalesTerritoryHistory].[AuditBatchId] = @_AuditBatchId;
    ...
    BEGIN
      ...
      BEGIN
        ...
        SELECT
           [AuditSalesTerritoryHistory].[BusinessEntityID]
          ,[AuditSalesTerritoryHistory].[TerritoryID]
          ,[AuditSalesTerritoryHistory].[StartDate]
          ,[AuditSalesTerritoryHistory].[EndDate]
          ,[AuditSalesTerritoryHistory].[rowguid]
          ,[AuditSalesTerritoryHistory].[RowStatus]
          ,[AuditSalesTerritoryHistory].[CreatedBy]
          ,[AuditSalesTerritoryHistory].[ModifiedBy]
          ,[AuditSalesTerritoryHistory].[CreatedDate]
          ,[AuditSalesTerritoryHistory].[ModifiedDate]
          ,[AuditSalesTerritoryHistory].[Uuid]
        FROM
          [Audit].[AuditSalesTerritoryHistory] AS [AuditSalesTerritoryHistory] WITH(NOLOCK)
        WHERE
          [AuditSalesTerritoryHistory].[AuditBatchId] = @_AuditBatchId;
...
EXEC Sales.uspDel_SalesTerritoryHistoryByUuid
  @Uuid = @Uuid,
...
SELECT AuditSalesTerritoryHistory.*
FROM   Audit.AuditSalesTerritoryHistory AS AuditSalesTerritoryHistory WITH(NOLOCK)
WHERE
  AuditSalesTerritoryHistory.AuditBatchId = @AuditBatchId
;
...
EXECUTE sp_addextendedproperty
  ...
  @level1name = N'uspDel_SalesTerritoryHistoryByUuid';
GO