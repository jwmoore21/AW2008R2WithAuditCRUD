/*
IF EXISTS (SELECT 1 FROM [sys].[objects] WHERE object_id = OBJECT_ID(N'[Sales].[uspDel_SalesPersonQuotaHistoryByUuid]') AND type in (N'P', N'PC'))
DROP PROCEDURE [Sales].[uspDel_SalesPersonQuotaHistoryByUuid]
GO
*/

CREATE PROCEDURE [Sales].[uspDel_SalesPersonQuotaHistoryByUuid]
...
================================================================================
Schema:      Sales
Object:      uspDel_SalesPersonQuotaHistoryByUuid
...
BEGIN
  ...
  BEGIN TRY
    ...
    SET @_AuditOperation = COALESCE( @AuditOperation, 'Delete proc ran: uspDel_SalesPersonQuotaHistoryByUuid' );
    ...
    BEGIN
      ...
      WHERE
        [SalesPersonQuotaHistory].[Uuid] = @_Uuid
      ;
...
EXEC Sales.uspDel_SalesPersonQuotaHistoryByUuid
  @Uuid = @Uuid,
...
EXECUTE sp_addextendedproperty
  ...
  @level1name = N'uspDel_SalesPersonQuotaHistoryByUuid';
GO