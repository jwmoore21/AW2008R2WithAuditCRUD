...
/* Defaults */
ALTER TABLE [Production].[ProductModelProductDescriptionCulture] ADD CONSTRAINT [DF__ProductModelProductDescriptionCulture__RowStatus] DEFAULT ((1)) FOR [RowStatus]
GO

ALTER TABLE [Production].[ProductModelProductDescriptionCulture] ADD CONSTRAINT [DF__ProductModelProductDescriptionCulture__CreatedBy] DEFAULT ('4E3A7D6D-8351-8494-FDB7-39E2A3A2E972') FOR [CreatedBy]
GO

ALTER TABLE [Production].[ProductModelProductDescriptionCulture] ADD CONSTRAINT [DF__ProductModelProductDescriptionCulture__ModifiedBy] DEFAULT ('4E3A7D6D-8351-8494-FDB7-39E2A3A2E972') FOR [ModifiedBy]
GO

ALTER TABLE [Production].[ProductModelProductDescriptionCulture] ADD CONSTRAINT [DF__ProductModelProductDescriptionCulture__CreatedDate] DEFAULT (GETUTCDATE()) FOR [CreatedDate]
GO

ALTER TABLE [Production].[ProductModelProductDescriptionCulture] ADD CONSTRAINT [DF__ProductModelProductDescriptionCulture__ModifiedDate] DEFAULT (GETUTCDATE()) FOR [ModifiedDate]
GO

ALTER TABLE [Production].[ProductModelProductDescriptionCulture] ADD CONSTRAINT [DF__ProductModelProductDescriptionCulture__Uuid] DEFAULT (NEWID()) FOR [Uuid]
GO

EXECUTE sp_addextendedproperty @name = N'MS_Description', @value = N'Default constraint value of GETDATE()', @level0type = N'SCHEMA', @level0name = N'Production', @level1type = N'TABLE', @level1name = N'ProductModelProductDescriptionCulture', @level2type = N'CONSTRAINT', @level2name = N'DF__ProductModelProductDescriptionCulture__ModifiedDate';
GO
