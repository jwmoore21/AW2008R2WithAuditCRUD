...
/* Defaults */
ALTER TABLE [Production].[ProductInventory] ADD CONSTRAINT [DF__ProductInventory__RowStatus] DEFAULT ((1)) FOR [RowStatus]
GO

ALTER TABLE [Production].[ProductInventory] ADD CONSTRAINT [DF__ProductInventory__CreatedBy] DEFAULT ('4E3A7D6D-8351-8494-FDB7-39E2A3A2E972') FOR [CreatedBy]
GO

ALTER TABLE [Production].[ProductInventory] ADD CONSTRAINT [DF__ProductInventory__ModifiedBy] DEFAULT ('4E3A7D6D-8351-8494-FDB7-39E2A3A2E972') FOR [ModifiedBy]
GO

ALTER TABLE [Production].[ProductInventory] ADD CONSTRAINT [DF__ProductInventory__CreatedDate] DEFAULT (GETUTCDATE()) FOR [CreatedDate]
GO

ALTER TABLE [Production].[ProductInventory] ADD CONSTRAINT [DF__ProductInventory__ModifiedDate] DEFAULT (GETUTCDATE()) FOR [ModifiedDate]
GO

ALTER TABLE [Production].[ProductInventory] ADD CONSTRAINT [DF__ProductInventory__Uuid] DEFAULT (NEWID()) FOR [Uuid]
GO
...
GO
EXECUTE sp_addextendedproperty @name = N'MS_Description', @value = N'Default constraint value of GETDATE()', @level0type = N'SCHEMA', @level0name = N'Production', @level1type = N'TABLE', @level1name = N'ProductInventory', @level2type = N'CONSTRAINT', @level2name = N'DF__ProductInventory__ModifiedDate';
