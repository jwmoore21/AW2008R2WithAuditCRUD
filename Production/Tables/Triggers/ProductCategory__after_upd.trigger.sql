/*
IF EXISTS ( SELECT 1 FROM sys.triggers WHERE object_id = object_id(N'[Production].[TRG__ProductCategory__after_upd]'))
DROP TRIGGER [Production].[TRG__ProductCategory__after_upd]
GO
*/
CREATE TRIGGER [Production].[TRG__ProductCategory__after_upd] ON [Production].[ProductCategory]
  AFTER UPDATE
AS

/*******************************************************************************
Schema:      Production
Object:      TRG__ProductCategory__after_upd
...
BEGIN
  ...
  BEGIN TRY
    ...
    SET @_AuditOperation = 'Autosave by: AFTER UPDATE Trigger : TRG__ProductCategory__after_upd';
    /* ========================================================================= */
    ...
    /* Insert into a TEMP table, all of our deleted values */
    INSERT INTO [Audit].[AuditProductCategory]
    (
       [AuditStatus]
      ,[AuditAppUser]
      ,[AuditSqlUser]
