/*
IF EXISTS ( SELECT 1 FROM sys.triggers WHERE object_id = object_id(N'[Production].[TRG__ProductModel__instead_of_del]'))
DROP TRIGGER [Production].[TRG__ProductModel__instead_of_del]
GO
*/
CREATE TRIGGER [Production].[TRG__ProductModel__instead_of_del] ON [Production].[ProductModel]
  INSTEAD OF DELETE
AS

/*******************************************************************************
Schema:      Production
Object:      TRG__ProductModel__instead_of_del
...
BEGIN
  ...
  BEGIN TRY
    ...
    SET @_AuditOperation = 'Autosave by: INSTEAD OF DELETE Trigger : TRG__ProductModel__instead_of_del';
    ...
    FROM [Production].[ProductModel] AS recordsToErase
