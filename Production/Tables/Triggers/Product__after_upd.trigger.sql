/*
IF EXISTS ( SELECT 1 FROM sys.triggers WHERE object_id = object_id(N'[Production].[TRG__Product__after_upd]'))
DROP TRIGGER [Production].[TRG__Product__after_upd]
GO
*/
CREATE TRIGGER [Production].[TRG__Product__after_upd] ON [Production].[Product]
  AFTER UPDATE
AS

/*******************************************************************************
Schema:      Production
Object:      TRG__Product__after_upd
...
BEGIN
  ...
  BEGIN TRY
    ...
    SET @_AuditOperation = 'Autosave by: AFTER UPDATE Trigger : TRG__Product__after_upd';
    /* ========================================================================= */
    ...
    FROM
      ...
      UPDATE Production.Product
        SET
          Product.ModifiedDate = GETUTCDATE()
      FROM Production.Product AS Product
        INNER JOIN @AuditRecordsToSave AS AuditRecordsToSave
        ON AuditRecordsToSave.[Uuid] = Product.[Uuid]
      ;
