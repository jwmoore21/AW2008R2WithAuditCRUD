/*
IF EXISTS ( SELECT 1 FROM sys.triggers WHERE object_id = object_id(N'[Production].[TRG__ProductDescription__instead_of_del]'))
DROP TRIGGER [Production].[TRG__ProductDescription__instead_of_del]
GO
*/
CREATE TRIGGER [Production].[TRG__ProductDescription__instead_of_del] ON [Production].[ProductDescription]
  INSTEAD OF DELETE
AS

/*******************************************************************************
Schema:      Production
Object:      TRG__ProductDescription__instead_of_del
...
BEGIN
  ...
  BEGIN TRY
    ...
    SET @_AuditOperation = 'Autosave by: INSTEAD OF DELETE Trigger : TRG__ProductDescription__instead_of_del';
    ...
    /* Insert into a TEMP table, all of our deleted values */
    INSERT INTO [Audit].[AuditProductDescription]
    (
       [AuditStatus]
      ,[AuditAppUser]
      ,[AuditSqlUser]
    ...
    FROM [Production].[ProductDescription] AS recordsToErase
