/*
IF EXISTS ( SELECT 1 FROM sys.triggers WHERE object_id = object_id(N'[Production].[TRG__ProductDocument__instead_of_del]'))
DROP TRIGGER [Production].[TRG__ProductDocument__instead_of_del]
GO
*/
CREATE TRIGGER [Production].[TRG__ProductDocument__instead_of_del] ON [Production].[ProductDocument]
  INSTEAD OF DELETE
AS

/*******************************************************************************
Schema:      Production
Object:      TRG__ProductDocument__instead_of_del
...
BEGIN
  ...
  BEGIN TRY
    ...
    SET @_AuditOperation = 'Autosave by: INSTEAD OF DELETE Trigger : TRG__ProductDocument__instead_of_del';
    ...
    FROM [Production].[ProductDocument] AS recordsToErase
