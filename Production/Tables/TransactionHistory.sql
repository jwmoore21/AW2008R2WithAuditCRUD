...
/* Defaults */
ALTER TABLE [Production].[TransactionHistory] ADD CONSTRAINT [DF__TransactionHistory__RowStatus] DEFAULT ((1)) FOR [RowStatus]
GO

ALTER TABLE [Production].[TransactionHistory] ADD CONSTRAINT [DF__TransactionHistory__CreatedBy] DEFAULT ('4E3A7D6D-8351-8494-FDB7-39E2A3A2E972') FOR [CreatedBy]
GO

ALTER TABLE [Production].[TransactionHistory] ADD CONSTRAINT [DF__TransactionHistory__ModifiedBy] DEFAULT ('4E3A7D6D-8351-8494-FDB7-39E2A3A2E972') FOR [ModifiedBy]
GO

ALTER TABLE [Production].[TransactionHistory] ADD CONSTRAINT [DF__TransactionHistory__CreatedDate] DEFAULT (GETUTCDATE()) FOR [CreatedDate]
GO

ALTER TABLE [Production].[TransactionHistory] ADD CONSTRAINT [DF__TransactionHistory__ModifiedDate] DEFAULT (GETUTCDATE()) FOR [ModifiedDate]
GO

ALTER TABLE [Production].[TransactionHistory] ADD CONSTRAINT [DF__TransactionHistory__Uuid] DEFAULT (NEWID()) FOR [Uuid]
GO
...
GO
EXECUTE sp_addextendedproperty @name = N'MS_Description', @value = N'Default constraint value of GETDATE()', @level0type = N'SCHEMA', @level0name = N'Production', @level1type = N'TABLE', @level1name = N'TransactionHistory', @level2type = N'CONSTRAINT', @level2name = N'DF__TransactionHistory__ModifiedDate';
