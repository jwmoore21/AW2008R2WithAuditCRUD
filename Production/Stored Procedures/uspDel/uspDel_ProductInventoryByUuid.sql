/*
IF EXISTS (SELECT 1 FROM [sys].[objects] WHERE object_id = OBJECT_ID(N'[Production].[uspDel_ProductInventoryByUuid]') AND type in (N'P', N'PC'))
DROP PROCEDURE [Production].[uspDel_ProductInventoryByUuid]
GO
*/

CREATE PROCEDURE [Production].[uspDel_ProductInventoryByUuid]
...
================================================================================
Schema:      Production
Object:      uspDel_ProductInventoryByUuid
...
BEGIN
  ...
  BEGIN TRY
    ...
    SET @_AuditOperation = COALESCE( @AuditOperation, 'Delete proc ran: uspDel_ProductInventoryByUuid' );
...
EXEC Production.uspDel_ProductInventoryByUuid
  @Uuid = @Uuid,
...
EXECUTE sp_addextendedproperty
  ...
  @level1name = N'uspDel_ProductInventoryByUuid';
GO