/*
IF EXISTS (SELECT 1 FROM [sys].[objects] WHERE object_id = OBJECT_ID(N'[Production].[uspDel_ProductModelIllustrationByUuid]') AND type in (N'P', N'PC'))
DROP PROCEDURE [Production].[uspDel_ProductModelIllustrationByUuid]
GO
*/

CREATE PROCEDURE [Production].[uspDel_ProductModelIllustrationByUuid]
...
================================================================================
Schema:      Production
Object:      uspDel_ProductModelIllustrationByUuid
...
BEGIN
  ...
  BEGIN TRY
    ...
    SET @_AuditOperation = COALESCE( @AuditOperation, 'Delete proc ran: uspDel_ProductModelIllustrationByUuid' );
    ...
    BEGIN
      ...
      WHERE
        [ProductModelIllustration].[Uuid] = @_Uuid
      ;
...
EXEC Production.uspDel_ProductModelIllustrationByUuid
  @Uuid = @Uuid,
...
EXECUTE sp_addextendedproperty
  ...
  @level1name = N'uspDel_ProductModelIllustrationByUuid';
GO