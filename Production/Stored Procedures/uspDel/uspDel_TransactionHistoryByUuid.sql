/*
IF EXISTS (SELECT 1 FROM [sys].[objects] WHERE object_id = OBJECT_ID(N'[Production].[uspDel_TransactionHistoryByUuid]') AND type in (N'P', N'PC'))
DROP PROCEDURE [Production].[uspDel_TransactionHistoryByUuid]
GO
*/

CREATE PROCEDURE [Production].[uspDel_TransactionHistoryByUuid]
...
================================================================================
Schema:      Production
Object:      uspDel_TransactionHistoryByUuid
...
BEGIN
  ...
  BEGIN TRY
    ...
    SET @_AuditOperation = COALESCE( @AuditOperation, 'Delete proc ran: uspDel_TransactionHistoryByUuid' );
...
EXEC Production.uspDel_TransactionHistoryByUuid
  @Uuid = @Uuid,
...
EXECUTE sp_addextendedproperty
  ...
  @level1name = N'uspDel_TransactionHistoryByUuid';
GO