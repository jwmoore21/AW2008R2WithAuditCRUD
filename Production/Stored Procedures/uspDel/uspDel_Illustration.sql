/*
IF EXISTS (SELECT 1 FROM [sys].[objects] WHERE object_id = OBJECT_ID(N'[Production].[uspDel_Illustration]') AND type in (N'P', N'PC'))
DROP PROCEDURE [Production].[uspDel_Illustration]
GO
*/

CREATE PROCEDURE [Production].[uspDel_Illustration]
  @IllustrationID INT,
...
EXEC Production.uspDel_Illustration
...
EXECUTE sp_addextendedproperty
  ...
  @level1name = N'uspDel_Illustration';
GO