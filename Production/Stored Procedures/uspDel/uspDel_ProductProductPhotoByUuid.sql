/*
IF EXISTS (SELECT 1 FROM [sys].[objects] WHERE object_id = OBJECT_ID(N'[Production].[uspDel_ProductProductPhotoByUuid]') AND type in (N'P', N'PC'))
DROP PROCEDURE [Production].[uspDel_ProductProductPhotoByUuid]
GO
*/

CREATE PROCEDURE [Production].[uspDel_ProductProductPhotoByUuid]
...
================================================================================
Schema:      Production
Object:      uspDel_ProductProductPhotoByUuid
...
BEGIN
  ...
  BEGIN TRY
    ...
    SET @_AuditOperation = COALESCE( @AuditOperation, 'Delete proc ran: uspDel_ProductProductPhotoByUuid' );
    ...
    BEGIN
      ...
      WHERE
        [ProductProductPhoto].[Uuid] = @_Uuid
      ;
...
EXEC Production.uspDel_ProductProductPhotoByUuid
  @Uuid = @Uuid,
...
EXECUTE sp_addextendedproperty
  ...
  @level1name = N'uspDel_ProductProductPhotoByUuid';
GO