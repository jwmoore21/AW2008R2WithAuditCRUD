/*
IF EXISTS (SELECT 1 FROM [sys].[objects] WHERE object_id = OBJECT_ID(N'[Production].[uspDel_ProductDocumentByUuid]') AND type in (N'P', N'PC'))
DROP PROCEDURE [Production].[uspDel_ProductDocumentByUuid]
GO
*/

CREATE PROCEDURE [Production].[uspDel_ProductDocumentByUuid]
...
================================================================================
Schema:      Production
Object:      uspDel_ProductDocumentByUuid
...
BEGIN
  ...
  BEGIN TRY
    ...
    SET @_AuditOperation = COALESCE( @AuditOperation, 'Delete proc ran: uspDel_ProductDocumentByUuid' );
...
EXEC Production.uspDel_ProductDocumentByUuid
  @Uuid = @Uuid,
...
EXECUTE sp_addextendedproperty
  ...
  @level1name = N'uspDel_ProductDocumentByUuid';
GO