/*
IF EXISTS (SELECT 1 FROM [sys].[objects] WHERE object_id = OBJECT_ID(N'[Production].[uspDel_BillOfMaterialsByUuid]') AND type in (N'P', N'PC'))
DROP PROCEDURE [Production].[uspDel_BillOfMaterialsByUuid]
GO
*/

CREATE PROCEDURE [Production].[uspDel_BillOfMaterialsByUuid]
...
================================================================================
Schema:      Production
Object:      uspDel_BillOfMaterialsByUuid
...
BEGIN
  ...
  BEGIN TRY
    ...
    SET @_AuditOperation = COALESCE( @AuditOperation, 'Delete proc ran: uspDel_BillOfMaterialsByUuid' );
...
EXEC Production.uspDel_BillOfMaterialsByUuid
  @Uuid = @Uuid,
...
EXECUTE sp_addextendedproperty
  ...
  @level1name = N'uspDel_BillOfMaterialsByUuid';
GO