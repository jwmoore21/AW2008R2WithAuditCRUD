/*
IF EXISTS (SELECT 1 FROM [sys].[objects] WHERE object_id = OBJECT_ID(N'[Production].[uspDel_LocationByUuid]') AND type in (N'P', N'PC'))
DROP PROCEDURE [Production].[uspDel_LocationByUuid]
GO
*/

CREATE PROCEDURE [Production].[uspDel_LocationByUuid]
...
BEGIN
  ...
  BEGIN TRY
    ...
    SET @_AuditOperation = COALESCE( @AuditOperation, 'Delete proc ran: uspDel_LocationByUuid' );
...
EXEC Production.uspDel_LocationByUuid
  @Uuid = @Uuid,
...
EXECUTE sp_addextendedproperty
  ...
  @level1name = N'uspDel_LocationByUuid';
GO