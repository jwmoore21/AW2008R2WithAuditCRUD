/*
IF EXISTS (SELECT 1 FROM [sys].[objects] WHERE object_id = OBJECT_ID(N'[Production].[uspDel_ProductByUuid]') AND type in (N'P', N'PC'))
DROP PROCEDURE [Production].[uspDel_ProductByUuid]
GO
*/

CREATE PROCEDURE [Production].[uspDel_ProductByUuid]
...
BEGIN
  ...
  BEGIN TRY
    ...
    SET @_AuditOperation = COALESCE( @AuditOperation, 'Delete proc ran: uspDel_ProductByUuid' );
...
EXEC Production.uspDel_ProductByUuid
  @Uuid = @Uuid,
...
EXECUTE sp_addextendedproperty
  ...
  @level1name = N'uspDel_ProductByUuid';
GO