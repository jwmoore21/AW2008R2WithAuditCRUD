/*
IF EXISTS (SELECT 1 FROM [sys].[objects] WHERE object_id = OBJECT_ID(N'[Production].[uspDel_UnitMeasure]') AND type in (N'P', N'PC'))
DROP PROCEDURE [Production].[uspDel_UnitMeasure]
GO
*/

CREATE PROCEDURE [Production].[uspDel_UnitMeasure]
...
EXEC Production.uspDel_UnitMeasure
...
EXECUTE sp_addextendedproperty
  ...
  @level1name = N'uspDel_UnitMeasure';
GO