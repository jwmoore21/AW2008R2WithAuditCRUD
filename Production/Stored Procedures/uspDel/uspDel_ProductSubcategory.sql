/*
IF EXISTS (SELECT 1 FROM [sys].[objects] WHERE object_id = OBJECT_ID(N'[Production].[uspDel_ProductSubcategory]') AND type in (N'P', N'PC'))
DROP PROCEDURE [Production].[uspDel_ProductSubcategory]
GO
*/

CREATE PROCEDURE [Production].[uspDel_ProductSubcategory]
...
================================================================================
Schema:      Production
Object:      uspDel_ProductSubcategory
    ...
    BEGIN
      ...
      BEGIN
        ...
        SELECT
          ...
          ,[OutputTableVar].[ProductCategoryID]
          ,[OutputTableVar].[Name]
...
EXEC Production.uspDel_ProductSubcategory
...
EXECUTE sp_addextendedproperty
  ...
  @level1name = N'uspDel_ProductSubcategory';
GO