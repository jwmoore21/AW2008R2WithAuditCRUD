/*
IF EXISTS (SELECT 1 FROM [sys].[objects] WHERE object_id = OBJECT_ID(N'[Production].[uspDel_IllustrationByUuid]') AND type in (N'P', N'PC'))
DROP PROCEDURE [Production].[uspDel_IllustrationByUuid]
GO
*/

CREATE PROCEDURE [Production].[uspDel_IllustrationByUuid]
...
================================================================================
Schema:      Production
Object:      uspDel_IllustrationByUuid
...
BEGIN
  ...
  BEGIN TRY
    ...
    SET @_AuditOperation = COALESCE( @AuditOperation, 'Delete proc ran: uspDel_IllustrationByUuid' );
...
EXEC Production.uspDel_IllustrationByUuid
  @Uuid = @Uuid,
...
EXECUTE sp_addextendedproperty
  ...
  @level1name = N'uspDel_IllustrationByUuid';
GO