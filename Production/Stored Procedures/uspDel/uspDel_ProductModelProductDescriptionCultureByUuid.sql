/*
IF EXISTS (SELECT 1 FROM [sys].[objects] WHERE object_id = OBJECT_ID(N'[Production].[uspDel_ProductModelProductDescriptionCultureByUuid]') AND type in (N'P', N'PC'))
DROP PROCEDURE [Production].[uspDel_ProductModelProductDescriptionCultureByUuid]
GO
*/

CREATE PROCEDURE [Production].[uspDel_ProductModelProductDescriptionCultureByUuid]
...
================================================================================
Schema:      Production
Object:      uspDel_ProductModelProductDescriptionCultureByUuid
...
BEGIN
  ...
  BEGIN TRY
    ...
    SET @_AuditOperation = COALESCE( @AuditOperation, 'Delete proc ran: uspDel_ProductModelProductDescriptionCultureByUuid' );
    ...
    BEGIN
      ...
      WHERE
        [ProductModelProductDescriptionCulture].[Uuid] = @_Uuid
      ;
...
EXEC Production.uspDel_ProductModelProductDescriptionCultureByUuid
  @Uuid = @Uuid,
...
EXECUTE sp_addextendedproperty
  ...
  @level1name = N'uspDel_ProductModelProductDescriptionCultureByUuid';
GO