/*
IF EXISTS (SELECT 1 FROM [sys].[objects] WHERE object_id = OBJECT_ID(N'[Production].[uspDel_ProductListPriceHistoryWithAudit]') AND type in (N'P', N'PC'))
DROP PROCEDURE [Production].[uspDel_ProductListPriceHistoryWithAudit]
GO
*/

CREATE PROCEDURE [Production].[uspDel_ProductListPriceHistoryWithAudit]
  @ProductID INT,
  @StartDate DATETIME,
...
================================================================================
Schema:      Production
Object:      uspDel_ProductListPriceHistoryWithAudit
...
BEGIN
  ...
  BEGIN TRY
    ...
    SET @_AuditOperation = COALESCE( @AuditOperation, 'Delete proc ran: uspDel_ProductListPriceHistoryWithAudit' );
    ...
    (
      ...
      AND OBJECT_NAME([so].[parent_obj]) = 'ProductListPriceHistory'
      ...
      (
        ...
        AND [tables].[name] = 'AuditProductListPriceHistory'
      ) = 1
    ) = 1
    BEGIN
      ...
      WHERE
        [productlistpricehistory].[ProductID] = @_ProductID
        AND [productlistpricehistory].[StartDate] = @_StartDate
      ;
    ...
    BEGIN
      ...
      BEGIN
        ...
        INTO
          [Audit].[AuditProductListPriceHistory]
    ...
    FROM
      [Audit].[AuditProductListPriceHistory] AS [AuditProductListPriceHistory] WITH(NOLOCK)
    WHERE
      [AuditProductListPriceHistory].[AuditBatchId] = @_AuditBatchId;
    ...
    BEGIN
      ...
      BEGIN
        ...
        SELECT
           [AuditProductListPriceHistory].[ProductID]
          ,[AuditProductListPriceHistory].[StartDate]
          ,[AuditProductListPriceHistory].[EndDate]
          ,[AuditProductListPriceHistory].[ListPrice]
          ,[AuditProductListPriceHistory].[RowStatus]
          ,[AuditProductListPriceHistory].[CreatedBy]
          ,[AuditProductListPriceHistory].[ModifiedBy]
          ,[AuditProductListPriceHistory].[CreatedDate]
          ,[AuditProductListPriceHistory].[ModifiedDate]
          ,[AuditProductListPriceHistory].[Uuid]
        FROM
          [Audit].[AuditProductListPriceHistory] AS [AuditProductListPriceHistory] WITH(NOLOCK)
        WHERE
          [AuditProductListPriceHistory].[AuditBatchId] = @_AuditBatchId;
        ...
        BEGIN TRY
          SELECT
            ...
            (
              ...
              WHERE
                [AuditProductListPriceHistory].[AuditBatchId] = @_AuditBatchId
              FOR XML PATH ('ProductListPriceHistory'), ROOT ('DeletedRecords'), ELEMENTS XSINIL
            );
...
EXEC Production.uspDel_ProductListPriceHistoryWithAudit
  @ProductID = @ProductID,
  @StartDate = @StartDate,
...
SELECT AuditProductListPriceHistory.*
FROM   Audit.AuditProductListPriceHistory AS AuditProductListPriceHistory WITH(NOLOCK)
WHERE
  AuditProductListPriceHistory.AuditBatchId = @AuditBatchId
;
...
EXECUTE sp_addextendedproperty
  ...
  @level1name = N'uspDel_ProductListPriceHistoryWithAudit';
GO