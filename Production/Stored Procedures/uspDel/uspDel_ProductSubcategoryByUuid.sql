/*
IF EXISTS (SELECT 1 FROM [sys].[objects] WHERE object_id = OBJECT_ID(N'[Production].[uspDel_ProductSubcategoryByUuid]') AND type in (N'P', N'PC'))
DROP PROCEDURE [Production].[uspDel_ProductSubcategoryByUuid]
GO
*/

CREATE PROCEDURE [Production].[uspDel_ProductSubcategoryByUuid]
...
================================================================================
Schema:      Production
Object:      uspDel_ProductSubcategoryByUuid
...
BEGIN
  ...
  BEGIN TRY
    ...
    SET @_AuditOperation = COALESCE( @AuditOperation, 'Delete proc ran: uspDel_ProductSubcategoryByUuid' );
...
EXEC Production.uspDel_ProductSubcategoryByUuid
  @Uuid = @Uuid,
...
EXECUTE sp_addextendedproperty
  ...
  @level1name = N'uspDel_ProductSubcategoryByUuid';
GO