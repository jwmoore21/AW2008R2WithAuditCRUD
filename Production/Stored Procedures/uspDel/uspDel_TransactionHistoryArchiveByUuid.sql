/*
IF EXISTS (SELECT 1 FROM [sys].[objects] WHERE object_id = OBJECT_ID(N'[Production].[uspDel_TransactionHistoryArchiveByUuid]') AND type in (N'P', N'PC'))
DROP PROCEDURE [Production].[uspDel_TransactionHistoryArchiveByUuid]
GO
*/

CREATE PROCEDURE [Production].[uspDel_TransactionHistoryArchiveByUuid]
...
================================================================================
Schema:      Production
Object:      uspDel_TransactionHistoryArchiveByUuid
...
BEGIN
  ...
  BEGIN TRY
    ...
    SET @_AuditOperation = COALESCE( @AuditOperation, 'Delete proc ran: uspDel_TransactionHistoryArchiveByUuid' );
    ...
    BEGIN
      ...
      WHERE
        [TransactionHistoryArchive].[Uuid] = @_Uuid
      ;
...
EXEC Production.uspDel_TransactionHistoryArchiveByUuid
  @Uuid = @Uuid,
...
EXECUTE sp_addextendedproperty
  ...
  @level1name = N'uspDel_TransactionHistoryArchiveByUuid';
GO