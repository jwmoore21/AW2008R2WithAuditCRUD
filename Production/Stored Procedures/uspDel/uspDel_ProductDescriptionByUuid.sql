/*
IF EXISTS (SELECT 1 FROM [sys].[objects] WHERE object_id = OBJECT_ID(N'[Production].[uspDel_ProductDescriptionByUuid]') AND type in (N'P', N'PC'))
DROP PROCEDURE [Production].[uspDel_ProductDescriptionByUuid]
GO
*/

CREATE PROCEDURE [Production].[uspDel_ProductDescriptionByUuid]
...
================================================================================
Schema:      Production
Object:      uspDel_ProductDescriptionByUuid
...
BEGIN
  ...
  BEGIN TRY
    ...
    SET @_AuditOperation = COALESCE( @AuditOperation, 'Delete proc ran: uspDel_ProductDescriptionByUuid' );
...
EXEC Production.uspDel_ProductDescriptionByUuid
  @Uuid = @Uuid,
...
EXECUTE sp_addextendedproperty
  ...
  @level1name = N'uspDel_ProductDescriptionByUuid';
GO