/*
IF EXISTS (SELECT 1 FROM [sys].[objects] WHERE object_id = OBJECT_ID(N'[Production].[uspDel_ProductReviewByUuid]') AND type in (N'P', N'PC'))
DROP PROCEDURE [Production].[uspDel_ProductReviewByUuid]
GO
*/

CREATE PROCEDURE [Production].[uspDel_ProductReviewByUuid]
...
================================================================================
Schema:      Production
Object:      uspDel_ProductReviewByUuid
...
BEGIN
  ...
  BEGIN TRY
    ...
    SET @_AuditOperation = COALESCE( @AuditOperation, 'Delete proc ran: uspDel_ProductReviewByUuid' );
...
EXEC Production.uspDel_ProductReviewByUuid
  @Uuid = @Uuid,
...
EXECUTE sp_addextendedproperty
  ...
  @level1name = N'uspDel_ProductReviewByUuid';
GO