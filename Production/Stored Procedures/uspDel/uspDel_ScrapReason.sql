/*
IF EXISTS (SELECT 1 FROM [sys].[objects] WHERE object_id = OBJECT_ID(N'[Production].[uspDel_ScrapReason]') AND type in (N'P', N'PC'))
DROP PROCEDURE [Production].[uspDel_ScrapReason]
GO
*/

CREATE PROCEDURE [Production].[uspDel_ScrapReason]
...
EXEC Production.uspDel_ScrapReason
...
EXECUTE sp_addextendedproperty
  ...
  @level1name = N'uspDel_ScrapReason';
GO