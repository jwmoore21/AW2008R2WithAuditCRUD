/*
IF EXISTS (SELECT 1 FROM [sys].[objects] WHERE object_id = OBJECT_ID(N'[Production].[uspDel_productphoto]') AND type in (N'P', N'PC'))
DROP PROCEDURE [Production].[uspDel_productphoto]
GO
*/

CREATE PROCEDURE [Production].[uspDel_productphoto]
  @ProductPhotoID INT,
    ...
    BEGIN
      ...
      BEGIN
        ...
        SELECT
          ...
          ,[OutputTableVar].[ThumbNailPhoto]
          ,[OutputTableVar].[ThumbnailPhotoFileName]
          ,[OutputTableVar].[LargePhoto]
          ,[OutputTableVar].[LargePhotoFileName]
...
EXEC Production.uspDel_productphoto
...
EXECUTE sp_addextendedproperty
  ...
  @level1name = N'uspDel_productphoto';
GO