/*
IF EXISTS (SELECT 1 FROM [sys].[objects] WHERE object_id = OBJECT_ID(N'[Production].[uspDel_UnitMeasureByUuid]') AND type in (N'P', N'PC'))
DROP PROCEDURE [Production].[uspDel_UnitMeasureByUuid]
GO
*/

CREATE PROCEDURE [Production].[uspDel_UnitMeasureByUuid]
...
================================================================================
Schema:      Production
Object:      uspDel_UnitMeasureByUuid
...
BEGIN
  ...
  BEGIN TRY
    ...
    SET @_AuditOperation = COALESCE( @AuditOperation, 'Delete proc ran: uspDel_UnitMeasureByUuid' );
...
EXEC Production.uspDel_UnitMeasureByUuid
  @Uuid = @Uuid,
...
EXECUTE sp_addextendedproperty
  ...
  @level1name = N'uspDel_UnitMeasureByUuid';
GO