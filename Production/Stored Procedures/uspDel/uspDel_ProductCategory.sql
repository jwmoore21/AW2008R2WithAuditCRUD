/*
IF EXISTS (SELECT 1 FROM [sys].[objects] WHERE object_id = OBJECT_ID(N'[Production].[uspDel_ProductCategory]') AND type in (N'P', N'PC'))
DROP PROCEDURE [Production].[uspDel_ProductCategory]
GO
*/

CREATE PROCEDURE [Production].[uspDel_ProductCategory]
...
EXEC Production.uspDel_ProductCategory
...
EXECUTE sp_addextendedproperty
  ...
  @level1name = N'uspDel_ProductCategory';
GO