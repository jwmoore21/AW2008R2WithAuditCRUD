/*
IF EXISTS (SELECT 1 FROM [sys].[objects] WHERE object_id = OBJECT_ID(N'[Production].[uspDel_ProductModelWithAudit]') AND type in (N'P', N'PC'))
DROP PROCEDURE [Production].[uspDel_ProductModelWithAudit]
GO
*/

CREATE PROCEDURE [Production].[uspDel_ProductModelWithAudit]
  @ProductModelID INT,
...
================================================================================
Schema:      Production
Object:      uspDel_ProductModelWithAudit
...
BEGIN
  ...
  BEGIN TRY
    ...
    SET @_AuditOperation = COALESCE( @AuditOperation, 'Delete proc ran: uspDel_ProductModelWithAudit' );
...
EXEC Production.uspDel_ProductModelWithAudit
...
EXECUTE sp_addextendedproperty
  ...
  @level1name = N'uspDel_ProductModelWithAudit';
GO