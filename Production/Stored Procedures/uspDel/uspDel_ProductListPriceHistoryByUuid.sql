/*
IF EXISTS (SELECT 1 FROM [sys].[objects] WHERE object_id = OBJECT_ID(N'[Production].[uspDel_ProductListPriceHistoryByUuid]') AND type in (N'P', N'PC'))
DROP PROCEDURE [Production].[uspDel_ProductListPriceHistoryByUuid]
GO
*/

CREATE PROCEDURE [Production].[uspDel_ProductListPriceHistoryByUuid]
...
================================================================================
Schema:      Production
Object:      uspDel_ProductListPriceHistoryByUuid
...
BEGIN
  ...
  BEGIN TRY
    ...
    SET @_AuditOperation = COALESCE( @AuditOperation, 'Delete proc ran: uspDel_ProductListPriceHistoryByUuid' );
    ...
    BEGIN
      ...
      WHERE
        [ProductListPriceHistory].[Uuid] = @_Uuid
      ;
...
EXEC Production.uspDel_ProductListPriceHistoryByUuid
  @Uuid = @Uuid,
...
EXECUTE sp_addextendedproperty
  ...
  @level1name = N'uspDel_ProductListPriceHistoryByUuid';
GO