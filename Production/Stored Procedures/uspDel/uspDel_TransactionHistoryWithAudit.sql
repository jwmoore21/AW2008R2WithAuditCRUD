/*
IF EXISTS (SELECT 1 FROM [sys].[objects] WHERE object_id = OBJECT_ID(N'[Production].[uspDel_TransactionHistoryWithAudit]') AND type in (N'P', N'PC'))
DROP PROCEDURE [Production].[uspDel_TransactionHistoryWithAudit]
GO
*/

CREATE PROCEDURE [Production].[uspDel_TransactionHistoryWithAudit]
  @TransactionID INT,
...
================================================================================
Schema:      Production
Object:      uspDel_TransactionHistoryWithAudit
...
BEGIN
  ...
  BEGIN TRY
    ...
    SET @_AuditOperation = COALESCE( @AuditOperation, 'Delete proc ran: uspDel_TransactionHistoryWithAudit' );
    ...
    (
      ...
      AND OBJECT_NAME([so].[parent_obj]) = 'TransactionHistory'
      ...
      (
        ...
        AND [tables].[name] = 'AuditTransactionHistory'
      ) = 1
    ) = 1
    BEGIN
      ...
      WHERE
        [TransactionHistory].[TransactionID] = @_TransactionID
      ;
    ...
    FROM
      [Audit].[AuditTransactionHistory] AS [AuditTransactionHistory] WITH(NOLOCK)
    WHERE
      [AuditTransactionHistory].[AuditBatchId] = @_AuditBatchId;
    ...
    BEGIN
      ...
      BEGIN
        ...
        SELECT
           [AuditTransactionHistory].[TransactionID]
          ,[AuditTransactionHistory].[ProductID]
          ,[AuditTransactionHistory].[ReferenceOrderID]
          ,[AuditTransactionHistory].[ReferenceOrderLineID]
          ,[AuditTransactionHistory].[TransactionDate]
          ,[AuditTransactionHistory].[TransactionType]
          ,[AuditTransactionHistory].[Quantity]
          ,[AuditTransactionHistory].[ActualCost]
          ,[AuditTransactionHistory].[RowStatus]
          ,[AuditTransactionHistory].[CreatedBy]
          ,[AuditTransactionHistory].[ModifiedBy]
          ,[AuditTransactionHistory].[CreatedDate]
          ,[AuditTransactionHistory].[ModifiedDate]
          ,[AuditTransactionHistory].[Uuid]
        FROM
          [Audit].[AuditTransactionHistory] AS [AuditTransactionHistory] WITH(NOLOCK)
        WHERE
          [AuditTransactionHistory].[AuditBatchId] = @_AuditBatchId;
        ...
        BEGIN TRY
          SELECT
            ...
            (
              ...
              WHERE
                [AuditTransactionHistory].[AuditBatchId] = @_AuditBatchId
              FOR XML PATH ('TransactionHistory'), ROOT ('DeletedRecords'), ELEMENTS XSINIL
            );
...
EXEC Production.uspDel_TransactionHistoryWithAudit
...
SELECT AuditTransactionHistory.*
FROM   Audit.AuditTransactionHistory AS AuditTransactionHistory WITH(NOLOCK)
WHERE
  AuditTransactionHistory.AuditBatchId = @AuditBatchId
;
...
EXECUTE sp_addextendedproperty
  ...
  @level1name = N'uspDel_TransactionHistoryWithAudit';
GO