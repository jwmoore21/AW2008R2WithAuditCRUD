/*
IF EXISTS (SELECT 1 FROM [sys].[objects] WHERE object_id = OBJECT_ID(N'[Production].[uspDel_ScrapReasonByUuid]') AND type in (N'P', N'PC'))
DROP PROCEDURE [Production].[uspDel_ScrapReasonByUuid]
GO
*/

CREATE PROCEDURE [Production].[uspDel_ScrapReasonByUuid]
...
================================================================================
Schema:      Production
Object:      uspDel_ScrapReasonByUuid
...
BEGIN
  ...
  BEGIN TRY
    ...
    SET @_AuditOperation = COALESCE( @AuditOperation, 'Delete proc ran: uspDel_ScrapReasonByUuid' );
...
EXEC Production.uspDel_ScrapReasonByUuid
  @Uuid = @Uuid,
...
EXECUTE sp_addextendedproperty
  ...
  @level1name = N'uspDel_ScrapReasonByUuid';
GO