/*
IF EXISTS (SELECT 1 FROM [sys].[objects] WHERE object_id = OBJECT_ID(N'[Production].[uspDel_ProductModelProductDescriptionCultureWithAudit]') AND type in (N'P', N'PC'))
DROP PROCEDURE [Production].[uspDel_ProductModelProductDescriptionCultureWithAudit]
GO
*/

CREATE PROCEDURE [Production].[uspDel_ProductModelProductDescriptionCultureWithAudit]
  @ProductModelID INT,
...
================================================================================
Schema:      Production
Object:      uspDel_ProductModelProductDescriptionCultureWithAudit
...
BEGIN
  ...
  BEGIN TRY
    ...
    SET @_AuditOperation = COALESCE( @AuditOperation, 'Delete proc ran: uspDel_ProductModelProductDescriptionCultureWithAudit' );

    /* ------------------------------------------------------------------------- */
    /* Table Primary Key(s) */
    DECLARE @_ProductModelID  INT;
    DECLARE @_ProductDescriptionID  INT;
    DECLARE @_CultureID  NCHAR;
    SET @_ProductModelID = @ProductModelID;
    SET @_ProductDescriptionID = @ProductDescriptionID;
    ...
    (
      ...
      AND OBJECT_NAME([so].[parent_obj]) = 'ProductModelProductDescriptionCulture'
      ...
      (
        ...
        AND [tables].[name] = 'AuditProductModelProductDescriptionCulture'
      ) = 1
    ) = 1
    BEGIN
      ...
      WHERE
        [productmodelproductdescriptionculture].[ProductModelID] = @_ProductModelID
        AND [productmodelproductdescriptionculture].[ProductDescriptionID] = @_ProductDescriptionID
        AND [productmodelproductdescriptionculture].[CultureID] = @_CultureID
      ;
    ...
    BEGIN
      ...
      BEGIN
        ...
        INTO
          [Audit].[AuditProductModelProductDescriptionCulture]
    ...
    FROM
      [Audit].[AuditProductModelProductDescriptionCulture] AS [AuditProductModelProductDescriptionCulture] WITH(NOLOCK)
    WHERE
      [AuditProductModelProductDescriptionCulture].[AuditBatchId] = @_AuditBatchId;
    ...
    BEGIN
      ...
      BEGIN
        ...
        SELECT
           [AuditProductModelProductDescriptionCulture].[ProductModelID]
          ,[AuditProductModelProductDescriptionCulture].[ProductDescriptionID]
          ,[AuditProductModelProductDescriptionCulture].[CultureID]
          ,[AuditProductModelProductDescriptionCulture].[RowStatus]
          ,[AuditProductModelProductDescriptionCulture].[CreatedBy]
          ,[AuditProductModelProductDescriptionCulture].[ModifiedBy]
          ,[AuditProductModelProductDescriptionCulture].[CreatedDate]
          ,[AuditProductModelProductDescriptionCulture].[ModifiedDate]
          ,[AuditProductModelProductDescriptionCulture].[Uuid]
        FROM
          [Audit].[AuditProductModelProductDescriptionCulture] AS [AuditProductModelProductDescriptionCulture] WITH(NOLOCK)
        WHERE
          [AuditProductModelProductDescriptionCulture].[AuditBatchId] = @_AuditBatchId;
        ...
        BEGIN TRY
          SELECT
            ...
            (
              ...
              WHERE
                [AuditProductModelProductDescriptionCulture].[AuditBatchId] = @_AuditBatchId
              FOR XML PATH ('ProductModelProductDescriptionCulture'), ROOT ('DeletedRecords'), ELEMENTS XSINIL
            );
...
SET @ProductDescriptionID = FILL IN;
DECLARE @CultureID NCHAR;
SET @CultureID = FILL IN;

EXEC Production.uspDel_ProductModelProductDescriptionCultureWithAudit
...
SELECT AuditProductModelProductDescriptionCulture.*
FROM   Audit.AuditProductModelProductDescriptionCulture AS AuditProductModelProductDescriptionCulture WITH(NOLOCK)
WHERE
  AuditProductModelProductDescriptionCulture.AuditBatchId = @AuditBatchId
;
...
EXECUTE sp_addextendedproperty
  ...
  @level1name = N'uspDel_ProductModelProductDescriptionCultureWithAudit';
GO