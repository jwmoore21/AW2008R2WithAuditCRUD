/*
IF EXISTS (SELECT 1 FROM [sys].[objects] WHERE object_id = OBJECT_ID(N'[Production].[uspDel_TransactionHistoryArchiveWithAudit]') AND type in (N'P', N'PC'))
DROP PROCEDURE [Production].[uspDel_TransactionHistoryArchiveWithAudit]
GO
*/

CREATE PROCEDURE [Production].[uspDel_TransactionHistoryArchiveWithAudit]
  @TransactionID INT,
...
================================================================================
Schema:      Production
Object:      uspDel_TransactionHistoryArchiveWithAudit
...
BEGIN
  ...
  BEGIN TRY
    ...
    SET @_AuditOperation = COALESCE( @AuditOperation, 'Delete proc ran: uspDel_TransactionHistoryArchiveWithAudit' );

    /* ------------------------------------------------------------------------- */
    /* Table Primary Key(s) */
    DECLARE @_TransactionID  INT;
    SET @_TransactionID = @TransactionID;
    ...
    (
      ...
      AND OBJECT_NAME([so].[parent_obj]) = 'TransactionHistoryArchive'
      ...
      (
        ...
        AND [tables].[name] = 'AuditTransactionHistoryArchive'
      ) = 1
    ) = 1
    BEGIN
      ...
      WHERE
        [TransactionHistoryArchive].[TransactionID] = @_TransactionID
      ;
    ...
    BEGIN
      ...
      BEGIN
        ...
        OUTPUT
          ...
          [DELETED].[ProductID],
          [DELETED].[ReferenceOrderID],
          [DELETED].[ReferenceOrderLineID],
        ...
        INTO
          [Audit].[AuditTransactionHistoryArchive]
    ...
    FROM
      [Audit].[AuditTransactionHistoryArchive] AS [AuditTransactionHistoryArchive] WITH(NOLOCK)
    WHERE
      [AuditTransactionHistoryArchive].[AuditBatchId] = @_AuditBatchId;
    ...
    BEGIN
      ...
      BEGIN
        ...
        SELECT
           [AuditTransactionHistoryArchive].[TransactionID]
          ,[AuditTransactionHistoryArchive].[ProductID]
          ,[AuditTransactionHistoryArchive].[ReferenceOrderID]
          ,[AuditTransactionHistoryArchive].[ReferenceOrderLineID]
          ,[AuditTransactionHistoryArchive].[TransactionDate]
          ,[AuditTransactionHistoryArchive].[TransactionType]
          ,[AuditTransactionHistoryArchive].[Quantity]
          ,[AuditTransactionHistoryArchive].[ActualCost]
          ,[AuditTransactionHistoryArchive].[RowStatus]
          ,[AuditTransactionHistoryArchive].[CreatedBy]
          ,[AuditTransactionHistoryArchive].[ModifiedBy]
          ,[AuditTransactionHistoryArchive].[CreatedDate]
          ,[AuditTransactionHistoryArchive].[ModifiedDate]
          ,[AuditTransactionHistoryArchive].[Uuid]
        FROM
          [Audit].[AuditTransactionHistoryArchive] AS [AuditTransactionHistoryArchive] WITH(NOLOCK)
        WHERE
          [AuditTransactionHistoryArchive].[AuditBatchId] = @_AuditBatchId;
        ...
        BEGIN TRY
          SELECT
            ...
            (
              ...
              WHERE
                [AuditTransactionHistoryArchive].[AuditBatchId] = @_AuditBatchId
              FOR XML PATH ('TransactionHistoryArchive'), ROOT ('DeletedRecords'), ELEMENTS XSINIL
            );
...
EXEC Production.uspDel_TransactionHistoryArchiveWithAudit
...
SELECT AuditTransactionHistoryArchive.*
FROM   Audit.AuditTransactionHistoryArchive AS AuditTransactionHistoryArchive WITH(NOLOCK)
WHERE
  AuditTransactionHistoryArchive.AuditBatchId = @AuditBatchId
;
...
EXECUTE sp_addextendedproperty
  ...
  @level1name = N'uspDel_TransactionHistoryArchiveWithAudit';
GO