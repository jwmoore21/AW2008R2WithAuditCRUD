/*
IF EXISTS (SELECT 1 FROM [sys].[objects] WHERE object_id = OBJECT_ID(N'[Production].[uspDel_ProductCategoryByUuid]') AND type in (N'P', N'PC'))
DROP PROCEDURE [Production].[uspDel_ProductCategoryByUuid]
GO
*/

CREATE PROCEDURE [Production].[uspDel_ProductCategoryByUuid]
...
================================================================================
Schema:      Production
Object:      uspDel_ProductCategoryByUuid
...
BEGIN
  ...
  BEGIN TRY
    ...
    SET @_AuditOperation = COALESCE( @AuditOperation, 'Delete proc ran: uspDel_ProductCategoryByUuid' );
...
EXEC Production.uspDel_ProductCategoryByUuid
  @Uuid = @Uuid,
...
EXECUTE sp_addextendedproperty
  ...
  @level1name = N'uspDel_ProductCategoryByUuid';
GO