/*
IF EXISTS (SELECT 1 FROM [sys].[objects] WHERE object_id = OBJECT_ID(N'[Production].[uspDel_WorkOrderRoutingByUuid]') AND type in (N'P', N'PC'))
DROP PROCEDURE [Production].[uspDel_WorkOrderRoutingByUuid]
GO
*/

CREATE PROCEDURE [Production].[uspDel_WorkOrderRoutingByUuid]
...
================================================================================
Schema:      Production
Object:      uspDel_WorkOrderRoutingByUuid
...
BEGIN
  ...
  BEGIN TRY
    ...
    SET @_AuditOperation = COALESCE( @AuditOperation, 'Delete proc ran: uspDel_WorkOrderRoutingByUuid' );
...
EXEC Production.uspDel_WorkOrderRoutingByUuid
  @Uuid = @Uuid,
...
EXECUTE sp_addextendedproperty
  ...
  @level1name = N'uspDel_WorkOrderRoutingByUuid';
GO