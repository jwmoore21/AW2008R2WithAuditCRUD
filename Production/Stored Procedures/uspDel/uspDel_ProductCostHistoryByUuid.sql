/*
IF EXISTS (SELECT 1 FROM [sys].[objects] WHERE object_id = OBJECT_ID(N'[Production].[uspDel_ProductCostHistoryByUuid]') AND type in (N'P', N'PC'))
DROP PROCEDURE [Production].[uspDel_ProductCostHistoryByUuid]
GO
*/

CREATE PROCEDURE [Production].[uspDel_ProductCostHistoryByUuid]
...
================================================================================
Schema:      Production
Object:      uspDel_ProductCostHistoryByUuid
...
BEGIN
  ...
  BEGIN TRY
    ...
    SET @_AuditOperation = COALESCE( @AuditOperation, 'Delete proc ran: uspDel_ProductCostHistoryByUuid' );
...
EXEC Production.uspDel_ProductCostHistoryByUuid
  @Uuid = @Uuid,
...
EXECUTE sp_addextendedproperty
  ...
  @level1name = N'uspDel_ProductCostHistoryByUuid';
GO