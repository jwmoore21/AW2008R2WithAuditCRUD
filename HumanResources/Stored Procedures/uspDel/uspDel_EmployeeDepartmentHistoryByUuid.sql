/*
IF EXISTS (SELECT 1 FROM [sys].[objects] WHERE object_id = OBJECT_ID(N'[HumanResources].[uspDel_EmployeeDepartmentHistoryByUuid]') AND type in (N'P', N'PC'))
DROP PROCEDURE [HumanResources].[uspDel_EmployeeDepartmentHistoryByUuid]
GO
*/

CREATE PROCEDURE [HumanResources].[uspDel_EmployeeDepartmentHistoryByUuid]
...
Object:      uspDel_EmployeeDepartmentHistoryByUuid
...
BEGIN
  ...
  BEGIN TRY
    ...
    SET @_AuditOperation = COALESCE( @AuditOperation, 'Delete proc ran: uspDel_EmployeeDepartmentHistoryByUuid' );
    ...
    BEGIN
      ...
      WHERE
        [EmployeeDepartmentHistory].[Uuid] = @_Uuid
      ;
...
EXEC HumanResources.uspDel_EmployeeDepartmentHistoryByUuid
  @Uuid = @Uuid,
...
EXECUTE sp_addextendedproperty
  ...
  @level1name = N'uspDel_EmployeeDepartmentHistoryByUuid';
GO