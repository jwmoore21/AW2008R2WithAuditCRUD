/*
IF EXISTS (SELECT 1 FROM [sys].[objects] WHERE object_id = OBJECT_ID(N'[HumanResources].[uspDel_EmployeePayHistoryByUuid]') AND type in (N'P', N'PC'))
DROP PROCEDURE [HumanResources].[uspDel_EmployeePayHistoryByUuid]
GO
*/

CREATE PROCEDURE [HumanResources].[uspDel_EmployeePayHistoryByUuid]
...
Object:      uspDel_EmployeePayHistoryByUuid
...
BEGIN
  ...
  BEGIN TRY
    ...
    SET @_AuditOperation = COALESCE( @AuditOperation, 'Delete proc ran: uspDel_EmployeePayHistoryByUuid' );
...
EXEC HumanResources.uspDel_EmployeePayHistoryByUuid
  @Uuid = @Uuid,
...
EXECUTE sp_addextendedproperty
  ...
  @level1name = N'uspDel_EmployeePayHistoryByUuid';
GO