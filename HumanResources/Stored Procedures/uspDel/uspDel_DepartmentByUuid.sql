/*
IF EXISTS (SELECT 1 FROM [sys].[objects] WHERE object_id = OBJECT_ID(N'[HumanResources].[uspDel_DepartmentByUuid]') AND type in (N'P', N'PC'))
DROP PROCEDURE [HumanResources].[uspDel_DepartmentByUuid]
GO
*/

CREATE PROCEDURE [HumanResources].[uspDel_DepartmentByUuid]
...
Object:      uspDel_DepartmentByUuid
...
BEGIN
  ...
  BEGIN TRY
    ...
    SET @_AuditOperation = COALESCE( @AuditOperation, 'Delete proc ran: uspDel_DepartmentByUuid' );
...
EXEC HumanResources.uspDel_DepartmentByUuid
  @Uuid = @Uuid,
...
EXECUTE sp_addextendedproperty
  ...
  @level1name = N'uspDel_DepartmentByUuid';
GO