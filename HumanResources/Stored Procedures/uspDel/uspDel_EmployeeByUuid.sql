/*
IF EXISTS (SELECT 1 FROM [sys].[objects] WHERE object_id = OBJECT_ID(N'[HumanResources].[uspDel_EmployeeByUuid]') AND type in (N'P', N'PC'))
DROP PROCEDURE [HumanResources].[uspDel_EmployeeByUuid]
GO
*/

CREATE PROCEDURE [HumanResources].[uspDel_EmployeeByUuid]
...
BEGIN
  ...
  BEGIN TRY
    ...
    SET @_AuditOperation = COALESCE( @AuditOperation, 'Delete proc ran: uspDel_EmployeeByUuid' );
...
EXEC HumanResources.uspDel_EmployeeByUuid
  @Uuid = @Uuid,
...
EXECUTE sp_addextendedproperty
  ...
  @level1name = N'uspDel_EmployeeByUuid';
GO