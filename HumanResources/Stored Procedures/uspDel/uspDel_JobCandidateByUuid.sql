/*
IF EXISTS (SELECT 1 FROM [sys].[objects] WHERE object_id = OBJECT_ID(N'[HumanResources].[uspDel_JobCandidateByUuid]') AND type in (N'P', N'PC'))
DROP PROCEDURE [HumanResources].[uspDel_JobCandidateByUuid]
GO
*/

CREATE PROCEDURE [HumanResources].[uspDel_JobCandidateByUuid]
...
Object:      uspDel_JobCandidateByUuid
...
BEGIN
  ...
  BEGIN TRY
    ...
    SET @_AuditOperation = COALESCE( @AuditOperation, 'Delete proc ran: uspDel_JobCandidateByUuid' );
...
EXEC HumanResources.uspDel_JobCandidateByUuid
  @Uuid = @Uuid,
...
EXECUTE sp_addextendedproperty
  ...
  @level1name = N'uspDel_JobCandidateByUuid';
GO