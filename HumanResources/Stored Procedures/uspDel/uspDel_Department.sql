/*
IF EXISTS (SELECT 1 FROM [sys].[objects] WHERE object_id = OBJECT_ID(N'[HumanResources].[uspDel_department]') AND type in (N'P', N'PC'))
DROP PROCEDURE [HumanResources].[uspDel_department]
GO
*/

CREATE PROCEDURE [HumanResources].[uspDel_department]
  ...
  BEGIN TRY
    ...
    BEGIN
      ...
      BEGIN
        ...
        SELECT
           [OutputTableVar].[DepartmentID]
          ,[OutputTableVar].[Name]
          ,[OutputTableVar].[GroupName]
...
EXEC HumanResources.uspDel_department
...
EXECUTE sp_addextendedproperty
  ...
  @level1name = N'uspDel_department';
GO