...
/* Defaults */
ALTER TABLE [HumanResources].[EmployeePayHistory] ADD CONSTRAINT [DF__EmployeePayHistory__RowStatus] DEFAULT ((1)) FOR [RowStatus]
GO

ALTER TABLE [HumanResources].[EmployeePayHistory] ADD CONSTRAINT [DF__EmployeePayHistory__CreatedBy] DEFAULT ('4E3A7D6D-8351-8494-FDB7-39E2A3A2E972') FOR [CreatedBy]
GO

ALTER TABLE [HumanResources].[EmployeePayHistory] ADD CONSTRAINT [DF__EmployeePayHistory__ModifiedBy] DEFAULT ('4E3A7D6D-8351-8494-FDB7-39E2A3A2E972') FOR [ModifiedBy]
GO

ALTER TABLE [HumanResources].[EmployeePayHistory] ADD CONSTRAINT [DF__EmployeePayHistory__CreatedDate] DEFAULT (GETUTCDATE()) FOR [CreatedDate]
GO

ALTER TABLE [HumanResources].[EmployeePayHistory] ADD CONSTRAINT [DF__EmployeePayHistory__ModifiedDate] DEFAULT (GETUTCDATE()) FOR [ModifiedDate]
GO

ALTER TABLE [HumanResources].[EmployeePayHistory] ADD CONSTRAINT [DF__EmployeePayHistory__Uuid] DEFAULT (NEWID()) FOR [Uuid]
GO
...
EXEC sys.sp_addextendedproperty @name=N'MS_Description', @value=N'Default constraint value of GETDATE()' , @level0type=N'SCHEMA',@level0name=N'HumanResources', @level1type=N'TABLE',@level1name=N'EmployeePayHistory', @level2type=N'CONSTRAINT',@level2name=N'DF__EmployeePayHistory__ModifiedDate'
GO
