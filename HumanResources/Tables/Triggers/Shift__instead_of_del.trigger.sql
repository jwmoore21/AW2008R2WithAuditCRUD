/*
IF EXISTS ( SELECT 1 FROM sys.triggers WHERE object_id = object_id(N'[HumanResources].[TRG__Shift__instead_of_del]'))
DROP TRIGGER [HumanResources].[TRG__Shift__instead_of_del]
GO
*/
CREATE TRIGGER [HumanResources].[TRG__Shift__instead_of_del] ON [HumanResources].[Shift]
  INSTEAD OF DELETE
AS

/*******************************************************************************
Schema:      HumanResources
Object:      TRG__Shift__instead_of_del
...
BEGIN
  ...
  BEGIN TRY
    ...
    SET @_AuditOperation = 'Autosave by: INSTEAD OF DELETE Trigger : TRG__Shift__instead_of_del';
    ...
    FROM [HumanResources].[Shift] AS recordsToErase
