/*
IF EXISTS ( SELECT 1 FROM sys.triggers WHERE object_id = object_id(N'[HumanResources].[TRG__JobCandidate__instead_of_del]'))
DROP TRIGGER [HumanResources].[TRG__JobCandidate__instead_of_del]
GO
*/
CREATE TRIGGER [HumanResources].[TRG__JobCandidate__instead_of_del] ON [HumanResources].[JobCandidate]
  INSTEAD OF DELETE
AS

/*******************************************************************************
Schema:      HumanResources
Object:      TRG__JobCandidate__instead_of_del
...
BEGIN
  ...
  BEGIN TRY
    ...
    SET @_AuditOperation = 'Autosave by: INSTEAD OF DELETE Trigger : TRG__JobCandidate__instead_of_del';
    ...
    FROM [HumanResources].[JobCandidate] AS recordsToErase
