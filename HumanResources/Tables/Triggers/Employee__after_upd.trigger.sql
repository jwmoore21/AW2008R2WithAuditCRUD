/*
IF EXISTS ( SELECT 1 FROM sys.triggers WHERE object_id = object_id(N'[HumanResources].[TRG__Employee__after_upd]'))
DROP TRIGGER [HumanResources].[TRG__Employee__after_upd]
GO
*/
CREATE TRIGGER [HumanResources].[TRG__Employee__after_upd] ON [HumanResources].[Employee]
  AFTER UPDATE
AS

/*******************************************************************************
Schema:      HumanResources
Object:      TRG__Employee__after_upd
...
BEGIN
  ...
  BEGIN TRY
    ...
    SET @_AuditOperation = 'Autosave by: AFTER UPDATE Trigger : TRG__Employee__after_upd';
    /* ========================================================================= */
    ...
    FROM
      ...
      UPDATE HumanResources.Employee
        SET
          Employee.ModifiedDate = GETUTCDATE()
      FROM HumanResources.Employee AS Employee
        INNER JOIN @AuditRecordsToSave AS AuditRecordsToSave
        ON AuditRecordsToSave.[Uuid] = Employee.[Uuid]
      ;
