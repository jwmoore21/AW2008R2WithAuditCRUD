/*
IF EXISTS ( SELECT 1 FROM sys.triggers WHERE object_id = object_id(N'[HumanResources].[TRG__Department__after_upd]'))
DROP TRIGGER [HumanResources].[TRG__Department__after_upd]
GO
*/
CREATE TRIGGER [HumanResources].[TRG__Department__after_upd] ON [HumanResources].[Department]
  AFTER UPDATE
AS

/*******************************************************************************
Schema:      HumanResources
Object:      TRG__Department__after_upd
...
BEGIN
  ...
  BEGIN TRY
    ...
    SET @_AuditOperation = 'Autosave by: AFTER UPDATE Trigger : TRG__Department__after_upd';
    /* ========================================================================= */
