/*
IF EXISTS ( SELECT 1 FROM sys.triggers WHERE object_id = object_id(N'[HumanResources].[TRG__EmployeeDepartmentHistory__instead_of_del]'))
DROP TRIGGER [HumanResources].[TRG__EmployeeDepartmentHistory__instead_of_del]
GO
*/
CREATE TRIGGER [HumanResources].[TRG__EmployeeDepartmentHistory__instead_of_del] ON [HumanResources].[EmployeeDepartmentHistory]
  INSTEAD OF DELETE
AS

/*******************************************************************************
Schema:      HumanResources
Object:      TRG__EmployeeDepartmentHistory__instead_of_del
...
BEGIN
  ...
  BEGIN TRY
    ...
    SET @_AuditOperation = 'Autosave by: INSTEAD OF DELETE Trigger : TRG__EmployeeDepartmentHistory__instead_of_del';
    ...
    FROM [HumanResources].[EmployeeDepartmentHistory] AS recordsToErase
