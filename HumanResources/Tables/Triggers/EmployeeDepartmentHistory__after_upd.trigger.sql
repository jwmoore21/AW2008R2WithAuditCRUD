/*
IF EXISTS ( SELECT 1 FROM sys.triggers WHERE object_id = object_id(N'[HumanResources].[TRG__EmployeeDepartmentHistory__after_upd]'))
DROP TRIGGER [HumanResources].[TRG__EmployeeDepartmentHistory__after_upd]
GO
*/
CREATE TRIGGER [HumanResources].[TRG__EmployeeDepartmentHistory__after_upd] ON [HumanResources].[EmployeeDepartmentHistory]
  AFTER UPDATE
AS

/*******************************************************************************
Schema:      HumanResources
Object:      TRG__EmployeeDepartmentHistory__after_upd
...
BEGIN
  ...
  BEGIN TRY
    ...
    SET @_AuditOperation = 'Autosave by: AFTER UPDATE Trigger : TRG__EmployeeDepartmentHistory__after_upd';
    /* ========================================================================= */
    ...
    /* Insert into a TEMP table, all of our deleted values */
    INSERT INTO [Audit].[AuditEmployeeDepartmentHistory]
    (
       [AuditStatus]
      ,[AuditAppUser]
      ,[AuditSqlUser]
    ...
    FROM
      ...
      UPDATE HumanResources.EmployeeDepartmentHistory
        SET
          EmployeeDepartmentHistory.ModifiedDate = GETUTCDATE()
      FROM HumanResources.EmployeeDepartmentHistory AS EmployeeDepartmentHistory
        ...
        ON AuditRecordsToSave.[Uuid] = EmployeeDepartmentHistory.[Uuid]
      ;
